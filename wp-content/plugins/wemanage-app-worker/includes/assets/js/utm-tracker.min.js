/* JavaScript Cookie v2.2.1 | Copyright 2006, 2015 Klaus Hartl & Fagner Brack | MIT license */ !(function(t) {
    var e, i, _;
...
(function() {
    ...
    function h() {
        ...
        try {
            e = new CustomEvent('nouvello_utm_event_attribution_set', {
                detail: {
                    attribution: nouvello_utm_tracker.attribution
                },
            });
        } catch (t) {
            (e = document.createEvent('Event')).initEvent(
                    'nouvello_utm_event_attribution_set', !1, !0
                ),
                (e.detail = {
                    attribution: nouvello_utm_tracker.attribution
                });
    ...
    function k() {
        ...
        ((t = new XMLHttpRequest()).open(
                'POST',
                nouvello_utm_tracker.ajax_url, !0
            ),
            t.setRequestHeader(
                'Content-type',
        ...
        (('init' != t && 'current_timestamp' in nouvello_utm_tracker) ||
            ...
            ((u = CookiesAFL),
                ...
                ((p = parseInt(u.get(m))),
                    ...
                    (u.set(r, c, s),
                        u.set(m, n, s),
                        (nouvello_utm_tracker.has_cookie_update = !0))), ['gclid', 'fbclid', 'msclkid'].forEach(function(t, e) {
                    var i = _ + t;
                    '' !== y(c, t) &&
                ...
                (t = {
                    updated_ts: nouvello_utm_tracker.current_timestamp
                }),
                void 0 !== u.get(i) &&
