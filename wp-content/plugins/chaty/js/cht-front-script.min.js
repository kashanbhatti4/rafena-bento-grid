function getWidgetIndex(t) {
    return null != t && "widget_index" != t || (t = 1), jQuery("#chaty-widget-" + t).length || jQuery("#chaty-widget_-" + t).length || jQuery(".chaty").length && 0 != (t = jQuery(".chaty:first").data("id")) && (t = t.replace(/[^0-9]/g, "")), t
}

function activateChatyWidget(t) {
    jQuery(".chaty-outer-forms").removeClass("active"), jQuery("#chaty-widget-" + t).length && jQuery("#chaty-widget-" + t).addClass("active"), jQuery("#chaty-widget-_" + t).length && jQuery("#chaty-widget-_" + t).addClass("active")
}

function launch_chaty(t) {
    activateChatyWidget(t = getWidgetIndex(t)), jQuery("#chaty-widget-" + t).length && jQuery("#chaty-widget-" + t + " .chaty-cta-button .open-chaty").trigger("click"), jQuery("#chaty-widget-_" + t).length && jQuery("#chaty-widget-_" + t + " .chaty-cta-button .open-chaty").trigger("click")
}

function open_chaty_whatsapp_popup(t) {
    activateChatyWidget(t = getWidgetIndex(t)), jQuery("#chaty-widget-" + t).length && jQuery("#chaty-widget-" + t + " .Whatsapp-channel").trigger("click"), jQuery("#chaty-widget-_" + t).length && jQuery("#chaty-widget-_" + t + " .Whatsapp-channel").trigger("click")
}

function close_chaty_whatsapp_popup(t) {
    t = getWidgetIndex(t), jQuery("#chaty-form-" + t + "-Whatsapp").length && jQuery("#chaty-form-" + t + "-Whatsapp .whatsapp-form-close-btn").trigger("click"), jQuery("#chaty-form-_" + t + "-Whatsapp").length && jQuery("#chaty-form-_" + t + "-Whatsapp .whatsapp-form-close-btn").trigger("click")
}

function open_chaty_contact_form(t) {
    activateChatyWidget(t = getWidgetIndex(t)), jQuery("#chaty-widget-" + t).length && jQuery("#chaty-widget-" + t + " .Contact_Us-channel").trigger("click"), jQuery("#chaty-widget-_" + t).length && jQuery("#chaty-widget-_" + t + " .Contact_Us-channel").trigger("click")
}

function close_chaty_contact_form(t) {
    t = getWidgetIndex(t), jQuery("#chaty-form-" + t + "-Contact_Us").length && jQuery("#chaty-form-" + t + "-Contact_Us .chaty-close-button").trigger("click"), jQuery("#chaty-form-_" + t + "-Contact_Us").length && jQuery("#chaty-form-_" + t + "-Contact_Us .chaty-close-button").trigger("click")
}! function(t) {
    "use strict";
    ...
    function _() {
        ...
        n.length && t.each(n, (function(t, e) {
            E(e.triggers.has_countries) && !B(e.triggers.countries) && e.triggers.countries.length && (a = !0)
        })), a ? "" != (i = H()) ? b() : (e = "https://www.cloudflare.com/cdn-cgi/trace", t.get(e, (function(t) {
            var e, a = t.match("loc=(.*)");
            a.length > 1 && (a = a[1]) && ("" == (a = a.toUpperCase()) && (a = "-"), e = a, "undefined" != typeof Storage ? null == window.sessionStorage.getItem("chaty_user_country_code") && window.sessionStorage.setItem("chaty_user_country_code", e) : V("chaty_user_country_code") || N("chaty_user_country_code", e, 365), b())
        }))) : b()
    }
    ...
    function b() {
        n.length && (t("body").append('<svg width="39" height="39" viewBox="0 0 39 39" class="hide-cht-svg-bg" fill="none" xmlns="http://www.w3.org/2000/svg"><defs> <linearGradient id="linear-gradient" x1="0.892" y1="0.192" x2="0.128" y2="0.85" gradientUnits="objectBoundingBox"> <stop offset="0" stop-color="#4a64d5"/> <stop offset="0.322" stop-color="#9737bd"/> <stop offset="0.636" stop-color="#f15540"/> <stop offset="1" stop-color="#fecc69"/> </linearGradient> <linearGradient id="linear-gradient-insta-dm" x1="0.892" y1="0.192" x2="0.128" y2="0.85" gradientUnits="objectBoundingBox"> <stop offset="0" stop-color="#4A64D5"></stop> <stop offset="0.322" stop-color="#9737BD"></stop> <stop offset="0.636" stop-color="#F15540"></stop> <stop offset="1" stop-color="#FECC69"></stop> </linearGradient></defs>'), t.each(n, (function(e, a) {
                var c = "",
                    ...
                    f = {},
                    w = function(e) {
                        if (E(e.triggers.has_countries) && !B(e.triggers.countries) && e.triggers.countries.length && "-" != (i = H()) && -1 == t.inArray(i, e.triggers.countries)) return !1;
                        return !0
                    }(a);
                w = w && function(t) {
                    if (t.triggers.has_date_scheduling_rules) {
                        var e = t.triggers.date_scheduling_rules.start_date_time,
                            ...
                            c = new Date,
                            n = (c = q(c, t.triggers.time_diff)).getFullYear() + "-" + A(c.getMonth() + 1) + "-" + A(c.getDate()) + " " + A(c.getHours()) + ":" + A(c.getMinutes()) + ":" + A(c.getSeconds());
                        return "" == a && e <= n || ("" == e && a >= n || "" != e && "" != a && e <= n && a >= n)
                    }
                    return !0
                }(a), w = w && function(t) {
                    var e = !0;
                    if (E(t.triggers.has_day_hours_scheduling_rules) && t.triggers.day_hours_scheduling_rules.length > 0) {
                ...
                t.each(a.channels, (function(t, e) {
                    x(e) && ("Chatway" === e.channel ? (v = !0, _ = e.chatway_position, m = e, "inside-chaty" !== _ && "chat-view" !== a.settings.cta_type || (b = !0, g++, p.push(e))) : (f = e, p.push(e), g++))
                ...
                let I = "";
                if (v && (I = "has-chatway-channel"), (1 != g || !b) && w && g > 0 && !t("#chaty-widget-" + a.id).length) {
                    var M = L(a.settings);
                    M = "right" == M ? "right" : "left";
                    var S = U(a);
                    if ("chat-view" == a.settings.cta_type) {
                        var Q = "<div style='display: none' class='chaty chaty-has-chat-view chaty-id-" + a.id + " chaty-widget-" + a.id + " chaty-key-" + e + "' id='chaty-widget-" + a.id + "' data-key='" + e + "' data-id='" + a.id + "' data-identifier='" + a.identifier + "' data-nonce='" + a.settings.widget_token + "' ><div class='chaty-widget " + M + "-position'><div class='chaty-channels'><div class='chaty-channel-list' id='csaas-channels-" + a.id + "'></div><div class='chaty-i-trigger csaas-widget-trigger " + I + "'></div></div></div></div>";
                        t("body").append(Q),
                            function(e) {
                                var a = e.id,
                                    c = T(a);
                                ...
                                var n = e.settings.cta_body,
                                    ...
                                    s = t("title").text();
                                B(s) ? (n = n.replace(/{title}/g, ""), i = i.replace(/{title}/g, "")) : (n = n.replace(/{title}/g, s), i = i.replace(/{title}/g, s));
                        ...
                        Q = "<div style='display: none' class='chaty chaty-id-" + a.id + " chaty-widget-" + a.id + " chaty-key-" + e + "' id='chaty-widget-" + a.id + "' data-key='" + e + "' data-id='" + a.id + "' data-identifier='" + a.identifier + "' data-nonce='" + a.settings.widget_token + "' ><div class='chaty-widget " + M + "-position'><div class='chaty-channels'><div class='chaty-channel-list' id='csaas-channels-" + a.id + "'></div><div class='chaty-i-trigger csaas-widget-trigger " + I + "'></div></div></div></div>";
                        t("body").append(Q)
                    }
                    E(a.triggers.auto_hide_widget) && parseInt(a.triggers.hide_after) > 0 && (t("#chaty-widget-" + a.id).addClass("auto-hide-chaty"), t("#chaty-widget-" + a.id).attr("data-time", a.triggers.hide_after));
                    var z = R(a.id, "c-widget");
                    if (t("#chaty-widget-" + a.id).addClass(a.settings.show_cta), 1 == g && "chat-view" != a.settings.cta_type) {
                        "vertical" != a.settings.icon_view && (S = "right" != M ? "right" : "left");
                        var P = j(f, a.id, S);
                        t("#chaty-widget-" + a.id + " .chaty-i-trigger").append(P), t("#chaty-widget-" + a.id + " .chaty-i-trigger").addClass("single-channel"), t("#chaty-widget-" + a.id + " .chaty-i-trigger .chaty-channel").addClass("single"), t("#chaty-widget-" + a.id + " .chaty-widget").addClass("has-single");
                        var N = a.settings.cta_text;
                        "first_click" == a.settings.show_cta && (z ? (t("#chaty-widget-" + a.id + " .chaty-tooltip").removeClass("chaty-tooltip"), t("#chaty-widget-" + a.id + " .chaty-i-trigger .chaty-channel").addClass("active").addClass("chaty-tooltip").addClass("pos-" + S), t("#chaty-widget-" + a.id + " .chaty-i-trigger .chaty-channel").append("<span class='on-hover-text'>" + N + "</span>").addClass("active").addClass("has-on-hover"), t("#chaty-widget-" + a.id + " .chaty-i-trigger .chaty-channel a").append("<span class='on-hover-text'>" + N + "</span>").addClass("has-on-hover"), t("#chaty-widget-" + a.id + " .chaty-i-trigger .chaty-channel a").attr("data-text", N)) : t("#chaty-widget-" + a.id + " .chaty-i-trigger .chaty-channel a").append("<span class='on-hover-text'>" + N + "</span>").removeClass("active").addClass("has-on-hover")), "all_time" == a.settings.show_cta && (t("#chaty-widget-" + a.id + " .chaty-i-trigger .chaty-tooltip").append("<span class='on-hover-text'>" + N + "</span>").addClass("active").addClass("has-on-hover"), t("#chaty-widget-" + a.id + " .chaty-i-trigger.single-channel .chaty-channel a").attr("data-text", N));
                        var O = f;
                        ("Instagram" != O.channel_type || "#ffffff" != O.icon_color && "#fff" != O.icon_color) && (c += "#chaty-widget-" + a.id + " ." + O.channel + "-channel .color-element{ fill: " + O.icon_color + "; color: " + O.icon_color + ";}", c += "#chaty-widget-" + a.id + " .channel-icon-" + O.channel + " .color-element{ fill: " + O.icon_color + "; color: " + O.icon_color + ";}"), c += "#chaty-widget-" + a.id + " ." + O.channel + "-channel .chaty-custom-icon { background-color: " + O.icon_color + "; }", c += "#chaty-widget-" + a.id + " ." + O.channel + "-channel .chaty-svg { background-color: " + O.icon_color + ";}", c += "#chaty-widget-" + a.id + " .channel-icon-" + O.channel + " .chaty-svg { background-color: " + O.icon_color + ";}", "Contact_Us" == O.channel_type && (c += ".chaty-contact-form-box #chaty-submit-button-" + a.id + " {background-color: " + O.contact_form_settings.button_bg_color + "; color: " + O.contact_form_settings.button_text_color + ";} ", c += "#chaty-form-" + a.id + "-Contact_Us .chaty-contact-form-title {background-color: " + O.contact_form_settings.title_bg_color + "; } ");
                        var G = '<div class="chaty-channel chaty-cta-close chaty-tooltip pos-' + S + '" data-hover="' + a.settings.close_text + '"><div class="chaty-cta-button"><button type="button"><span class="chaty-svg"><svg viewBox="0 0 52 52" fill="none" xmlns="http://www.w3.org/2000/svg"><ellipse cx="26" cy="26" rx="26" ry="26" fill="' + a.settings.widget_color + '"></ellipse><rect width="27.1433" height="3.89857" rx="1.94928" transform="translate(18.35 15.6599) scale(0.998038 1.00196) rotate(45)" fill="' + a.settings.widget_icon_color + '"></rect><rect width="27.1433" height="3.89857" rx="1.94928" transform="translate(37.5056 18.422) scale(0.998038 1.00196) rotate(135)" fill="' + a.settings.widget_icon_color + '"></rect></svg></span><span class="sr-only">Hide chaty</span></button></div></div>';
                        t("#chaty-widget-" + a.id + " .chaty-i-trigger").append(G)
                    } else {
                        t.each(a.channels, (function(e, n) {
                            if (x(n) && ("Chatway" !== n.channel || "inside-chaty" === _ || "chat-view" === a.settings.cta_type)) {
                                if (W(n.channel_type) && (n.channel_type = n.channel), "chat-view" == a.settings.cta_type) {
                                    var i = j(n, a.id, "top");
                        ...
                        var V = function(t, e) {
                            ("" == t.widget_icon || "chat-image" == t.widget_icon && B(t.widget_icon_url) || "chat-fa-icon" == t.widget_icon && B(t.widget_fa_icon)) && (t.widget_icon = "chat-base");
                        ...
                        var X = S;
                        "horizontal" == a.settings.icon_view && (X = "left" == M ? "right" : "left");
                        var Z = '<div class="chaty-channel chaty-cta-main chaty-tooltip has-on-hover pos-' + X + ' active" data-widget="' + a.id + '" ><span class="on-hover-text">' + N + '</span><div class="chaty-cta-button"><button type="button" class="open-chaty">' + V + '<span class="sr-only">Open chaty</span></button><button type="button" class="open-chaty-channel"><span class="sr-only">chaty buttons</span></button></div></div>';
                        t("#chaty-widget-" + a.id + " .chaty-i-trigger").html(Z);
                        G = '<div class="chaty-channel chaty-cta-close chaty-tooltip pos-' + S + '" data-hover="' + a.settings.close_text + '"><div class="chaty-cta-button"><button type="button"><span class="chaty-svg"><svg viewBox="0 0 52 52" fill="none" xmlns="http://www.w3.org/2000/svg"><ellipse cx="26" cy="26" rx="26" ry="26" fill="' + a.settings.widget_color + '"></ellipse><rect width="27.1433" height="3.89857" rx="1.94928" transform="translate(18.35 15.6599) scale(0.998038 1.00196) rotate(45)" fill="' + a.settings.widget_icon_color + '"></rect><rect width="27.1433" height="3.89857" rx="1.94928" transform="translate(37.5056 18.422) scale(0.998038 1.00196) rotate(135)" fill="' + a.settings.widget_icon_color + '"></rect></svg></span><span class="sr-only">Hide chaty</span></button></div></div>';
                        t("#chaty-widget-" + a.id + " .chaty-i-trigger").append(G)
                    }
                    t.each(a.channels, (function(t, e) {
                        "Contact_Us" == e.channel_type && "yes" == e.hide_recaptcha_badge && (c += ".grecaptcha-badge {visibility: hidden;}")
                    })), "chat-view" == a.settings.cta_type && a.settings.show_close_button, !(z = R(a.id, "c-widget")) || "open" == a.settings.default_state && 1 != g || (function(e, a) {
                        var c = R(a, "c-widget");
                    ...
                    var Y = 0;
                    if ("open" != a.settings.default_state || E(a.settings.show_close_button) || (t("#chaty-widget-" + a.id + " .chaty-widget").addClass("chaty-no-close-button").addClass("chaty-open"), Y = 1), v && (t("#chaty-widget-" + a.id + " .chaty-widget").addClass(_), "above-chaty" === _)) {
                    ...
                    E(a.settings.is_google_analytics_enabled) && (t("#chaty-widget-" + a.id + " .chaty-channel-list .chaty-channel > a").addClass("has-gae"), t("#chaty-form-" + a.id + "-chaty-chat-view .chaty-channel > a").addClass("has-gae"), t("#chaty-widget-" + a.id + " .chaty-i-trigger.single-channel .chaty-channel > a").addClass("has-gae"), t(".chaty-outer-forms.chaty-whatsapp-btn-form.chaty-form-" + a.id + " form.add-analytics").addClass("form-google-analytics"), t(".whatsapp-chaty-form-" + a.id).addClass("has-form-gae")), E(a.settings.has_custom_css) && !B(a.settings.custom_css) && (h += a.settings.custom_css), "hover" == a.settings.default_state ? t("#chaty-widget-" + a.id).addClass("open-on-hover") : "open" == a.settings.default_state && (t("#chaty-widget-" + a.id + " .chaty-widget").addClass("default-open"), !z && E(a.settings.show_close_button) || t("#chaty-widget-" + a.id + " .chaty-widget:not(.has-single)").addClass("chaty-open"), z || t("#chaty-widget-" + a.id + " .chaty-widget").removeClass("default-open")), t("#chaty-widget-" + a.id + " .chaty-widget:not(.has-single):not(.chaty-no-close-button)").hasClass("default-open") ? E(a.settings.bg_blur_effect) && t("body").addClass("add-bg-blur-effect") : t("body").removeClass("add-bg-blur-effect"), E(a.settings.bg_blur_effect) && t("#chaty-widget-" + a.id + " .chaty-widget:not(.chaty-no-close-button)").addClass("has-bg-blur-effect");
                    var F = function(t) {
                        return t
                    }(a.settings.widget_size, a.settings.custom_widget_size);
                    if (F = parseInt(F), c += "#chaty-widget-" + a.id + " .chaty-channel-list .chaty-channel {width: " + F + "px; height: " + F + "px; }", c += "#chaty-widget-" + a.id + " .chaty-channel-list .chaty-channel > a {width: " + F + "px; height: " + F + "px; }", c += "#chaty-widget-" + a.id + " .chaty-channel-list .chaty-channel > a .chaty-custom-icon {display:block; width: " + F + "px; height: " + F + "px; line-height: " + F + "px; font-size: " + parseInt(F / 2) + "px; }", c += "#chaty-widget-" + a.id + " .chaty-channel-list .chaty-channel button {width: " + F + "px; height: " + F + "px; margin: 0; padding:0; outline: none; border-radius: 50%;}", c += "#chaty-widget-" + a.id + " .chaty-channel-list .chaty-channel .chaty-svg {width: " + F + "px; height: " + F + "px; }", c += "#chaty-widget-" + a.id + " .chaty-channel-list .chaty-channel .chaty-svg img {width: " + F + "px; height: " + F + "px; }", c += "#chaty-widget-" + a.id + " .chaty-channel-list .chaty-channel span.chaty-icon {width: " + F + "px; height: " + F + "px; }", c += "#chaty-widget-" + a.id + " .chaty-channel-list .chaty-channel a {width: " + F + "px; height: " + F + "px; }", c += "#chaty-widget-" + a.id + " .chaty-channel-list .chaty-channel .chaty-svg .chaty-custom-channel-icon {width: " + F + "px; height: " + F + "px; line-height: " + F + "px; display: block; font-size:" + parseInt(F / 2) + "px; }", c += "#chaty-widget-" + a.id + " .chaty-i-trigger .chaty-cta-button {background-color: " + a.settings.widget_color + "; }", c += "#chaty-widget-" + a.id + " .chaty-i-trigger .chaty-cta-button button {background-color: " + a.settings.widget_color + "; }", c += "#chaty-widget-" + a.id + " .chaty-i-trigger .chaty-channel {width: " + F + "px; height: " + F + "px; }", c += "#chaty-widget-" + a.id + " .chaty-i-trigger .chaty-channel > a {width: " + F + "px; height: " + F + "px; }", c += "#chaty-widget-" + a.id + " .chaty-i-trigger .chaty-channel > a .chaty-custom-icon {display:block; width: " + F + "px; height: " + F + "px; line-height: " + F + "px; font-size: " + parseInt(F / 2) + "px; }", c += "#chaty-widget-" + a.id + " .chaty-i-trigger .chaty-channel button {width: " + F + "px; height: " + F + "px; margin: 0; padding:0; outline: none; border-radius: 50%;}", c += "#chaty-widget-" + a.id + " .chaty-i-trigger .chaty-channel .chaty-svg {width: " + F + "px; height: " + F + "px; }", c += "#chaty-widget-" + a.id + " .chaty-i-trigger .chaty-channel .chaty-svg img {width: " + F + "px; height: " + F + "px; }", c += "#chaty-widget-" + a.id + " .chaty-i-trigger .chaty-channel span.chaty-icon {width: " + F + "px; height: " + F + "px; }", c += "#chaty-widget-" + a.id + " .chaty-i-trigger .chaty-channel a {width: " + F + "px; height: " + F + "px; }", c += "#chaty-widget-" + a.id + " .chaty-i-trigger .chaty-channel .chaty-svg .chaty-custom-channel-icon {width: " + F + "px; height: " + F + "px; line-height: " + F + "px; display: block; font-size:" + parseInt(F / 2) + "px; }", c += "#chaty-widget-" + a.id + " .chaty-i-trigger .ch-pending-msg {background-color: " + a.settings.pending_mesg_count_bgcolor + "; color: " + a.settings.pending_mesg_count_color + "; }", c += "#chaty-widget-" + a.id + " .chaty-i-trigger .chaty-channel .chaty-svg .widget-fa-icon {line-height: " + F + "px; font-size:" + parseInt(F / 2) + "px; }", "vertical" == a.settings.icon_view) {
                        c += "#chaty-widget-" + a.id + " .chaty-channel-list {height: " + g * (F + 8) + "px; }", c += "#chaty-widget-" + a.id + " .chaty-channel-list {width: " + (F + 8) + "px; }";
                        for (var J = 0; J <= g; J++) c += "#chaty-widget-" + a.id + " .chaty-open .chaty-channel-list .chaty-channel:nth-child(" + (J + 1) + ") {-webkit-transform: translateY(-" + (F + 8) * (g - J - Y) + "px); transform: translateY(-" + (F + 8) * (g - J - Y) + "px);}", c += "#chaty-widget-" + a.id + " .chaty-open.above-chaty.has-chatway .chaty-channel-list .chaty-channel:nth-child(" + (J + 1) + ") {-webkit-transform: translateY(-" + (F + 8) * (g - J - Y + 1) + "px); transform: translateY(-" + (F + 8) * (g - J - Y + 1) + "px);}";
                        if (v && "inside-chaty" == _) {
                            let t = 0,
                                e = 1;
                            for (let n = 0; n < p.length; n++) O = p[n], c += "body.chatway--active #chaty-widget-" + a.id + " .chaty-open .chaty-channel-list .chaty-channel." + O.channel + "-link {-webkit-transform: translateY(-" + (F + 8) * (g - t - Y) + "px); transform: translateY(-" + (F + 8) * (g - t - Y) + "px);}", "Chatway" != O.channel ? c += "body:not(.chatway--active) #chaty-widget-" + a.id + " .chaty-open .chaty-channel-list .chaty-channel." + O.channel + "-channel-link {-webkit-transform: translateY(-" + (F + 8) * (g - t - e - Y) + "px); transform: translateY(-" + (F + 8) * (g - t - e - Y) + "px);}" : e = 0, t++
                        } else {
                            let t = 0;
                            for (t = 0; t <= g; t++) c += "#chaty-widget-" + a.id + " .chaty-open .chaty-channel-list .chaty-channel:nth-child(" + (t + 1) + ") {-webkit-transform: translateY(-" + (F + 8) * (g - t - Y) + "px); transform: translateY(-" + (F + 8) * (g - t - Y) + "px);}";
                            "above-chaty" == _ && (c += "#chaty-widget-" + a.id + " .chaty-channel-list .Chatway-channel-link {-webkit-transform: translateY(-" + (F + 8) * Y + "px); transform: translateY(-" + (F + 8) * (1 - Y) + "px);}")
                        }
                    } else {
                        t("#chaty-widget-" + a.id + " .chaty-widget").addClass("hor-mode"), c += "#chaty-widget-" + a.id + " .chaty-channel-list {width: " + g * (F + 8) + "px; }", c += "#chaty-widget-" + a.id + " .chaty-channel-list {height: " + F + "px; }";
                        let e = 0;
                        if (v && "inside-chaty" == _) {
                            let t = 0,
                                e = 1;
                            for (let n = 0; n < p.length; n++) O = p[n], c += "body.chatway--active .chaty-widget-" + a.id + " .chaty-widget.left-position.hor-mode.chaty-open .chaty-channel-list .chaty-channel:nth-child(" + (t + 1) + ") {-webkit-transform: translateX(" + (F + 8) * (g - t - Y) + "px); transform: translateX(" + (F + 8) * (g - t - Y) + "px);}", c += "body.chatway--active .chaty-widget-" + a.id + " .chaty-widget.right-position.hor-mode.chaty-open .chaty-channel-list .chaty-channel:nth-child(" + (t + 1) + ") {-webkit-transform: translateX(-" + (F + 8) * (g - t - Y) + "px); transform: translateX(-" + (F + 8) * (g - t - Y) + "px);}", "Chatway" != O.channel ? (c += "body:not(.chatway--active) #chaty-widget-" + a.id + " .chaty-widget.left-position.hor-mode.chaty-open .chaty-channel-list .chaty-channel:nth-child(" + (t + 1) + ") {-webkit-transform: translateX(" + (F + 8) * (g - t - e - Y) + "px); transform: translateX(" + (F + 8) * (g - t - e - Y) + "px);}", c += "body:not(.chatway--active) #chaty-widget-" + a.id + " .chaty-widget.right-position.hor-mode.chaty-open .chaty-channel-list .chaty-channel:nth-child(" + (t + 1) + ") {-webkit-transform: translateX(-" + (F + 8) * (g - t - e - Y) + "px); transform: translateX(-" + (F + 8) * (g - t - e - Y) + "px);}") : e = 0, t++
                        } else {
                            for (e = 0; e <= g; e++) c += "#chaty-widget-" + a.id + " .chaty-widget.left-position.hor-mode.chaty-open .chaty-channel-list .chaty-channel:nth-child(" + (e + 1) + ") {-webkit-transform: translateX(" + (F + 8) * (g - e - Y) + "px); transform: translateX(" + (F + 8) * (g - e - Y) + "px);}", c += "#chaty-widget-" + a.id + " .chaty-widget.right-position.hor-mode.chaty-open .chaty-channel-list .chaty-channel:nth-child(" + (e + 1) + ") {-webkit-transform: translateX(-" + (F + 8) * (g - e - Y) + "px); transform: translateX(-" + (F + 8) * (g - e - Y) + "px);}";
                            "above-chaty" == _ && (c += "#chaty-widget-" + a.id + " .chaty-widget.left-position.hor-mode .chaty-channel-list .Chatway-channel-link {-webkit-transform: translateX(" + (F + 8) * (1 - Y) + "px); transform: translateX(" + (F + 8) * (1 - Y) + "px);}", c += "#chaty-widget-" + a.id + " .chaty-widget.right-position.hor-mode .chaty-channel-list .Chatway-channel-link {-webkit-transform: translateX(-" + (F + 8) * (1 - Y) + "px); transform: translateX(-" + (F + 8) * (1 - Y) + "px);}")
                        }
                    }
                    var $ = a.settings.bottom_spacing,
                        K = a.settings.side_spacing;
                    c += "#chaty-widget-" + a.id + " .chaty-widget {bottom: " + $ + "px}", "left" == M ? (c += "#chaty-widget-" + a.id + " .chaty-widget {left: " + K + "px; right: auto;}", c += ".chaty-outer-forms.pos-left.chaty-form-" + a.id + " {left: " + K + "px}", t(".chaty-form-" + a.id).addClass("pos-left")) : (c += "#chaty-widget-" + a.id + " .chaty-widget {right: " + K + "px; left:auto;}", t(".chaty-form-" + a.id).addClass("pos-right"), c += ".chaty-outer-forms.pos-right.chaty-form-" + a.id + " {right: " + K + "px; left:auto;}"), t(".chaty-form-" + a.id).show();
                    var tt = F + 15 + parseInt($);
                    c += ".chaty-outer-forms.active.chaty-form-" + a.id + " {-webkit-transform: translateY(-" + tt + "px); transform: translateY(-" + tt + "px)} ", c += "#chaty-widget-" + a.id + ".chaty:not(.form-open) .chaty-widget.chaty-open + .chaty-chat-view {-webkit-transform: translateY(-" + tt + "px); transform: translateY(-" + tt + "px)} ", c += "#chaty-widget-" + a.id + " .chaty-tooltip:after {background-color: " + a.settings.cta_bg_color + "; color: " + a.settings.cta_text_color + "}", c += "#chaty-widget-" + a.id + " .chaty-tooltip.pos-top:before {border-top-color: " + a.settings.cta_bg_color + "; }", c += "#chaty-widget-" + a.id + " .chaty-tooltip.pos-left:before {border-left-color: " + a.settings.cta_bg_color + "; }", c += "#chaty-widget-" + a.id + " .chaty-tooltip.pos-right:before {border-right-color: " + a.settings.cta_bg_color + ";}", c += "#chaty-widget-" + a.id + " .on-hover-text {background-color: " + a.settings.cta_bg_color + "; color: " + a.settings.cta_text_color + "}", c += "#chaty-widget-" + a.id + " .on-hover-text p{background-color: " + a.settings.cta_bg_color + "; color: " + a.settings.cta_text_color + "}", c += "#chaty-widget-" + a.id + " .chaty-tooltip.pos-top .on-hover-text:before {border-top-color: " + a.settings.cta_bg_color + "; }", c += "#chaty-widget-" + a.id + " .chaty-tooltip.pos-left .on-hover-text:before {border-left-color: " + a.settings.cta_bg_color + "; }", c += "#chaty-widget-" + a.id + " .chaty-tooltip.pos-right .on-hover-text:before {border-right-color: " + a.settings.cta_bg_color + ";}";
                    var et = tt + 72 + F;
                    et > 0 && (c += ".chaty-outer-forms.chaty-form-" + a.id + " .chaty-agent-body {max-height: calc(100vh - " + et + "px); overflow-y: auto; } "), c += "#chaty-form-" + a.id + "-chaty-chat-view .chaty-view-header {background-color: " + a.settings.cta_head_bg_color + ";}", c += "#chaty-form-" + a.id + "-chaty-chat-view .chaty-view-header {color: " + a.settings.cta_head_text_color + ";}", c += "#chaty-form-" + a.id + "-chaty-chat-view .chaty-view-header svg {fill : " + a.settings.cta_head_text_color + ";}";
                    var at = tt + 82 + F;
                    at > 0 && (c += ".chaty-outer-forms.chaty-contact-form-box.chaty-form-" + a.id + " .chaty-contact-inputs {max-height: calc(100vh - " + at + "px); overflow-y: auto; } "), 25 == $ && 25 == K || (t(".chaty-outer-forms.chaty-form-" + a.id).addClass("custom-cht-pos"), t("#chaty-widget-" + a.id).addClass("has-custom-pos"));
                    var ct = parseInt(t("#chaty-form-" + a.id + "-Whatsapp .chaty-whatsapp-header").outerHeight()) + parseInt(t("#chaty-form-" + a.id + "-Whatsapp .chaty-whatsapp-footer").outerHeight()) + parseInt(F) + parseInt($) + 20;
                    if (c += "#chaty-form-" + a.id + "-Whatsapp .chaty-whatsapp-body { max-height: calc(100vh - " + ct + "px); overflow-y: auto; }", R(a.id, "v-widget") && (E(a.triggers.exit_intent) || E(a.triggers.has_time_delay) || E(a.triggers.has_display_after_page_scroll) > 0) ? (E(a.triggers.has_time_delay) && 0 == parseInt(a.triggers.time_delay) ? (k(a.id), t("#chaty-widget-" + a.id).addClass("active")) : E(a.triggers.has_time_delay) && parseInt(a.triggers.time_delay) > 0 && (l = !0, parseInt(a.triggers.time_delay) > r && (r = a.triggers.time_delay), t("#chaty-widget-" + a.id).addClass("on-chaty-delay"), t("#chaty-widget-" + a.id).addClass("delay-time-" + parseInt(a.triggers.time_delay)), t("#chaty-widget-" + a.id).attr("data-time", parseInt(a.triggers.time_delay))), E(a.triggers.has_display_after_page_scroll) && 0 == parseInt(a.triggers.display_after_page_scroll) ? (k(a.id), t("#chaty-widget-" + a.id).addClass("active")) : E(a.triggers.has_display_after_page_scroll) && parseInt(a.triggers.display_after_page_scroll) > 0 && (d = !0, t("#chaty-widget-" + a.id).addClass("on-chaty-scroll"), t("#chaty-widget-" + a.id).addClass("page-scroll-" + parseInt(a.triggers.display_after_page_scroll)), t("#chaty-widget-" + a.id).attr("data-scroll", parseInt(a.triggers.display_after_page_scroll))), E(a.triggers.exit_intent) && (y = !0, t("#chaty-widget-" + a.id).addClass("on-chaty-exit-intent"))) : (k(a.id), t("#chaty-widget-" + a.id).addClass("active")), !B(a.settings.font_family) && "none" != a.settings.font_family) {
                        var nt = a.settings.font_family; - 1 != t.inArray(nt, o) ? "System Stack" == nt && (nt = "-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Oxygen-Sans,Ubuntu,Cantarell,Helvetica Neue,sans-serif") : (t("head").append('<link rel="preload" as="style" href="https://fonts.googleapis.com/css?family=' + nt + '&display=swap">'), t("head").append('<link rel="stylesheet" href="https://fonts.googleapis.com/css?family=' + nt + '&display=swap">')), c += "#chaty-widget-" + a.id + ", #chaty-widget-" + a.id + " .chaty-tooltip:after {font-family: " + nt + "}"
                    }
                }
                y && (s ? function() {
                    if (window.history && window.history.pushState && y) {
                        function e() {
                            y && "" !== location.hash.split("#!/")[1] && "" === window.location.hash && D()
                        }
                        var a = 100;
                    ...
                    function e(t, e, a) {
                        t.addEventListener ? (t.addEventListener(e, a, !1), D()) : t.attachEvent && t.attachEvent("on" + e, a)
                    }
                    ...
                    t(this).closest(".chaty-widget").hasClass("has-single") ? t(this).closest(".chaty").hasClass("form-open") && (E(a.settings.bg_blur_effect) ? t("body").addClass("add-bg-blur-effect") : t("body").removeClass("add-bg-blur-effect")) : t(this).closest(".chaty-widget").hasClass("chaty-open") ? t("body").removeClass("add-bg-blur-effect") : t(this).closest(".chaty-widget").hasClass("chaty-no-close-button") || E(a.settings.bg_blur_effect) && t("body").addClass("add-bg-blur-effect")
                }))
            })), t("#custom-advance-chaty-css").length || t("head").append("<style id='custom-advance-chaty-css'></style>"), t("#custom-advance-chaty-css").append(u), (t(".v3_site_key").length && !B(t(".v3_site_key").val()) || t(".v2_site_key").length && !B(t(".v2_site_key").val())) && function() {
            ...
            function() {
                ...
                l && (a = setInterval((function() {
                    (p++, t(".chaty.delay-time-" + p).length) && z(t(".chaty.delay-time-" + p).data("id"))
                }), 1e3));
                if (d) {
    ...
    function x(t) {
        if (E(t.is_agent)) {
            if (t.agent_data.length && (!s && E(t.is_agent_desktop) || s && E(t.is_agent_mobile))) return !0
    ...
    function k(a) {
        if (t("#chaty-widget-" + a + " .chaty-channel.chaty-default-open").length) {
            ...
            if (!B(c)) {
                var i = R(a, "c-" + t("#chaty-widget-" + a + " .chaty-channel.chaty-default-open").data("channel"));
                if (i && (t("#" + c).addClass("is-active"), t("#" + c).length)) {
                    ...
                    if ("on" == chaty_settings.data_analytics_settings) {
                        var l = [],
                            r = t("#chaty-widget-" + a + " .chaty-channel.chaty-default-open").data("channel");
                        if (R(a, "v-" + r) && void 0 !== r && (G(a, "v-" + r), l.push(r)), !h && l.length) {
        ...
        if (g) {
            ...
            if (typeof n[u] != e) {
                ...
                null != m && "string" == typeof m ? (m = m.split(","), -1 == t.inArray(a, m) && (m.push(a), N("activechatyWidgets", m = m.join(","), 1))) : N("activechatyWidgets", m = a, 1)
            }
            if (t("#chaty-widget-" + a + " .chaty-widget").hasClass("has-single")) p = 1, r = t("#chaty-widget-" + a + " .chaty-channel").data("channel"), R(a, "v-" + r) && void 0 !== r && (G(a, "v-" + r), l.push(r));
                ...
                chatyChannel = t(this).data("channel"), (i = R(a, "v-" + chatyChannel)) && "undefined" != typeof chatyChannel && (G(a, "v-" + chatyChannel), l.push(chatyChannel))
            })) : t("#chaty-widget-" + a + " .chaty-channel-list .chaty-channel").each((function() {
                r = t(this).data("channel"), R(a, "v-" + r) && void 0 !== r && (G(a, "v-" + r), l.push(r))
            })));
            if (g && !h) {
    ...
    function j(e, a, c) {
        ...
        if (!E(e.is_agent)) {
            ...
            if ("Contact_Us" == e.channel_type) n += " has-chaty-box chaty-contact-form";
                ...
                if (E(e.is_default_open)) R(a, "c-" + e.channel_type) && (n += " chaty-default-open")
            }
                                ...
                                var h = function(e, a, c, n, i, o) {
                                    ...
                                    if ("Whatsapp" == a.channel_type) {
                                        ...
                                        if (!B(e.pre_set_message)) {
                                            ...
                                            var y = t("title").text();
                                            d = (d = B(y) ? d.replace(/{title}/g, "") : d.replace(/{title}/g, y)).replace(/{url}/g, window.location), d = encodeURIComponent(d)
                                        }
                                        s ? (l = "", h = "https://wa.me/" + r + "?text=" + d) : (l = "_blank", h = E(e.use_whatsapp_web) ? "https://web.whatsapp.com/send?phone=" + r + "&text=" + d : "https://wa.me/" + r + "?text=" + d)
                                    } else "WeChat" == a.channel_type ? (l = "", h = "#") : "Email" == a.channel_type ? (l = "", h = "mailto:" + e.value) : "Facebook_Messenger" == a.channel_type ? l = s ? "" : "_blank" : "SMS" == a.channel_type ? (l = "", h = "sms:" + e.value) : "Telegram" == a.channel_type ? (h = "https://telegram.me/" + (h = M(e.value, "@")), l = "_blank") : "Twitter" == a.channel_type ? h = "https://twitter.com/" + t.trim(e.value) : "Instagram" == a.channel_type ? h = "https://www.instagram.com/" + M(e.value, "@") : "Instagram_DM" == a.channel_type ? h = "https://ig.me/m/" + M(e.value, "@") : "Phone" == a.channel_type ? (l = "", h = "tel:" + t.trim(e.value)) : "Skype" == a.channel_type ? (l = "", h = "skype:" + t.trim(e.value) + "?chat") : "Snapchat" == a.channel_type ? h = "https://www.snapchat.com/add/" + t.trim(e.value) : "Vkontakte" == a.channel_type ? h = "https://vk.me/" + t.trim(e.value) : "Linkedin" == a.channel_type ? h = "personal" == e.link_type ? "https://www.linkedin.com/in/" + t.trim(e.value) : "https://www.linkedin.com/company/" + t.trim(e.value) : "Viber" == a.channel_type ? ("" != e.viber_url ? h = "viber://pa?chatURI=" + e.value : (h = M(e.value, "+"), isNaN(h) || (h = h.replace("+", ""), navigator.userAgent.match(/(iPod|iPhone|iPad)/) && (h = "+" + h), h = "viber://chat?number=" + h)), l = "") : "TikTok" == a.channel_type && (h = "https://www.tiktok.com/@" + (h = M(t.trim(e.value), "@")), l = "");
    ...
    function S(e, a, c, n) {
        ...
        if (E(e.is_agent)) e.url = "#", e.target = "";
            ...
            if (E(e.has_welcome_message)) e.url = "#", e.target = "", i += " has-chaty-box chaty-whatsapp-btn-form",
                function(e, a) {
                    const c = new Date;
                    ...
                    var l = "https://web.whatsapp.com/send",
                        r = "";
                    s ? l = "https://wa.me/" + e.value : (l = E(e.is_use_web_version) ? "https://web.whatsapp.com/send" : "https://wa.me/" + e.value, r = "_blank");
        ...
        }(e, n), e.url = "#", e.target = "", i += " has-chaty-box chaty-qr-code-form");
            ...
            c += "<div style='display:none;' class='chaty-outer-forms chaty-contact-form-box chaty-form-" + a + "' data-channel='" + e.channel_type + "' id='chaty-form-" + a + "-" + e.channel_type + "' data-widget='" + a + "' data-index='" + n + "'>", c += "<div class='chaty-form'>", c += "<div class='chaty-form-body'>", c += "<div role='button' class='close-chaty-form'><div aria-hidden='true' class='chaty-close-button'></div><span class='hide-cht-svg-bg'>" + chaty_settings.lang.hide_whatsapp_form + "</span></div>", c += "<form class='chaty-ajax-contact-form' id='chaty-ajax-contact-form-" + n + "' method='post' data-channel='" + e.channel_type + "' data-widget='" + a + "' data-token='" + e.widget_token + "' data-index='" + e.widget_index + "' enctype='multipart/form-data'>", c += "<div class='chaty-contact-form-body'>", c += "<div class='chaty-contact-form-title'><div class='form-title'>" + e.contact_form_settings.contact_form_title + "</div><div aria-hidden='true' class='chaty-close-button'><span class='hide-cht-svg-bg'>" + chaty_settings.lang.hide_whatsapp_form + "</span><svg width='15' height='9' viewBox='0 0 15 9' fill='none' xmlns='http://www.w3.org/2000/svg'> <path d='M1 1L7.31429 8L14 1' stroke='white' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'></path></svg></div></div>", c += "<div class='chaty-contact-inputs'>", t.each(e.contact_fields, (function(e, n) {
                ...
                var i = E(n.is_required) ? "is-required" : "",
                    s = "";
                E(n.is_required) && (s = "<span class='required_indicate'>*</span>"), E(n.is_custom) ? (c += "<label class='chaty-form-label' for='" + n.field_dropdown + "-" + e + "'>" + n.field_label + " " + s + "</label>", c += "<input type='hidden' name='custom_fields[" + e + "][label_" + n.field_dropdown + "]' value='" + n.field_label + "'>", c += "<input type='hidden' name='custom_fields[" + e + "][slug]' value='" + n.field_dropdown + "'>", "text" == n.field_dropdown || "url" == n.field_dropdown || "date" == n.field_dropdown ? c += "<input type='" + n.field_dropdown + "' class='chaty-input-field " + i + " field-" + n.field_dropdown + "' placeholder='" + n.placeholder + "' name='custom_fields[" + e + "][" + n.field_dropdown + "]' id='" + n.field_dropdown + "-" + e + "' />" : "file" == n.field_dropdown ? c += "<input type='file' class='chaty-input-field " + i + " field-" + n.field_dropdown + "' name='custom_fields[" + e + "][" + n.field_dropdown + "]' id='" + n.field_dropdown + "-" + e + "' accept='.jpg,.jpeg,.png,.gif,.pdf,.doc,.docx,.ppt,.pptx,.pps,.ppsx,.odt,.xls,.xlsx,.mp3,.mp4,.wav,.mpg,.avi,.mov,.wmv,.3gp,.ogv' multiple/>" : "textarea" == n.field_dropdown ? c += "<textarea class='chaty-textarea-field " + i + " field-" + n.field_dropdown + "' placeholder='" + n.placeholder + "' name='custom_fields[" + e + "][" + n.field_dropdown + "]' id='" + n.field_dropdown + "-" + e + "' ></textarea>" : "dropdown" == n.field_dropdown ? (c += "<select name='custom_fields[" + e + "][" + n.field_dropdown + "]' class='chaty-input-field " + i + "'>", n.dropdown_placeholder && (c += "<option value=''>" + n.dropdown_placeholder + "</option>"), t.each(n.dropdown_option, (function(t, e) {
            ...
            })), E(e.enable_recaptcha) && (B(e.v2_site_key) || (c += "<div class='chaty-contact-input'>", c += "<div class='front-google-captcha' id='front_recaptcha_" + n + "'></div>", c += "</div>"), B(e.v3_site_key) || (c += "<div class='chaty-contact-input'>", c += "<div class='front-google-captcha' id='front_recaptcha_" + n + "'></div>", c += "</div>"));
            ...
            c += '<input type="hidden" name="v2token" value="' + i + '">', E(e.enable_recaptcha) && (B(e.v2_site_key) || (c += "<input type='hidden' id='v2_site_key' class='v2_site_key' value='" + e.v2_site_key + "'>"), B(e.v3_site_key) || (c += "<input type='hidden' id='v3_site_key' class='v3_site_key' value='" + e.v3_site_key + "'>"));
            c += "</form>", c += "</div>", c += "</div>", c += "</div>", t("body").append(c)
        }(e, n), e.url = "#", e.target = "", i += " has-chaty-box chaty-contact-us-form";
        else if ("Email" == e.channel_type) {
            if (!B(e.mail_subject)) {
                var h, l = decodeURI(e.mail_subject);
                l = (l = B(h = t("title").text()) ? l.replace(/{title}/g, "") : l.replace(/{title}/g, h)).replace(/{url}/g, window.location), l = encodeURIComponent(l), e.url += "?subject=" + l
            }
        ...
        m = "Link" == e.channel || "Custom_Link" == e.channel || "Custom_Link_3" == e.channel || "Custom_Link_4" == e.channel || "Custom_Link_5" == e.channel ? B(e.hover_text) ? e.channel : e.hover_text : e.channel;
        var r = "";
        return B(e.click_event) || (r = 'onclick="' + e.click_event + '"', e.target = "", e.url = "#"), "<a href='" + e.url + "' " + r + " target='" + e.target + "' rel='nofollow noopener' aria-label='" + m + "' class='chaty-tooltip " + e.channel_type + "-channel chaty-link chaty-" + e.channel_type.toLowerCase() + "-channel pos-" + c + i + "' data-form='chaty-form-" + n + "-" + e.channel_type + "' data-hover='" + e.hover_text + "'>" + a + "</a>"
    }
    ...
    function U(t) {
        return "vertical" != t.settings.icon_view ? "top" : "right" == L(t.settings) ? "left" : "right"
    }

    function D() {
        y && t(".on-chaty-exit-intent").length && t(".on-chaty-exit-intent").each((function() {
            var e = t(this).data("id");
            t(this).removeClass("on-chaty-exit-intent"), z(e), t("#chaty-widget-" + e + " .chaty-widget").append("<div class='chaty-exit-intent'></div>"), setTimeout((function() {
    ...
    function z(e) {
        k(e), t(".chaty-widget-" + e).removeClass("on-chaty-delay"), t(".chaty-widget-" + e).removeClass("on-chaty-exit-intent"), t(".chaty-widget-" + e).removeClass("on-chaty-scroll"), t(".chaty.on-chaty-delay").length || (clearInterval(a), l = !1), t(".chaty.on-chaty-exit-intent").length || (y = !1), t(".chaty.on-chaty-scroll").length || (d = !1)
    }
    ...
    function H() {
        return i = "", "undefined" != typeof Storage && null != window.sessionStorage.getItem("chaty_user_country_code") ? i = window.sessionStorage.getItem("chaty_user_country_code") : V("chaty_user_country_code") && (i = O("chaty_user_country_code")), i
    }
    ...
    function O(t) {
        ...
        try {
            ...
            return a && "object" == typeof a && "expiry" in a ? Date.now() > a.expiry ? (localStorage.removeItem(t), null) : a.value : a
        } catch (t) {
            return e
        }
    }
    ...
    function V(t) {
        ...
        try {
            ...
            return !t || "object" != typeof t || !("expiry" in t) || Date.now() > t.expiry
        } catch (t) {
            return !0
        }
    }
    t(document).ready((function() {
        ...
        a.test(c) && (h = !0), s ? t("body").addClass("cht-in-mobile") : t("body").addClass("cht-in-desktop"), E(chaty_settings.has_chatway) && t("body").addClass("csaas-has-chatway"), "undefined" == typeof chaty_settings ? (console.log("Chaty settings doesn't exists"), chatyInterval = setInterval((function() {
            "object" == typeof chaty_settings && (clearInterval(chatyInterval), "object" != typeof chaty_settings || "on" == chaty_settings.data_analytics_settings && "off" != chaty_settings.data_analytics_settings || (h = !0), E(chaty_settings.has_chatway) && t("body").addClass("csaas-has-chatway"), n = chaty_settings.chaty_widgets, _())
            ...
            })), t(".form-open").removeClass("form-open"), t(".chaty-outer-forms").removeClass("active"), t(".chaty .chaty-widget.chaty-no-close-button:not(.has-single)").addClass("chaty-open"), t(".chaty .chaty-widget").hasClass("chaty-open") && (t(".chaty .chaty-widget:not(.chaty-no-close-button)").removeClass("chaty-open"), t("body").removeClass("add-bg-blur-effect")), t("body").removeClass("add-bg-blur-effect"), N("hide-bg-blur-effect", !0, 365), P()
            ...
            t(this).closest(".chaty").find(".chaty-widget").removeClass("chaty-open"), t("body").removeClass("add-bg-blur-effect"), N("hide-bg-blur-effect", !0, 365), P()
            ...
            t("#chaty-widget-" + c).length && (t("#chaty-widget-" + c).removeClass("form-open"), t(this).closest(".chaty-outer-forms").removeClass("active"), t("#chaty-widget-" + c).find(".chaty-widget").hasClass("cssas-no-close-button") && t("#chaty-widget-" + c).find(".chaty-widget:not(.has-single)").addClass("chaty-open")), t("body").hasClass("add-bg-blur-effect") && (t("body").removeClass("add-bg-blur-effect"), P())
            ...
            if (!B(a) || 0 == a) {
                ...
                t(this).hasClass("whatsapp-form-close-btn") && (n = R(a, "c-Whatsapp"), B(a) && 0 != a || !n || G(a, "c-Whatsapp"))
            }
            t("body").removeClass("add-bg-blur-effect")
            ...
            if (t(this).closest(".chaty").hasClass("form-open")) {
                ...
                t("#chaty-form-" + e + "-Whatsapp").length && t("#chaty-form-" + e + "-Whatsapp").hasClass("active") && (clickStatus = R(e, "c-Whatsapp"), B(e) && 0 != e || !clickStatus || G(e, "c-Whatsapp"))
            }
            ...
            if (void 0 !== o && void 0 !== t("#chaty-widget-" + o).data("identifier")) {
                ...
                if (v(o), t(this).closest(".chaty-channel").hasClass("chaty-cta-main") || t(this).closest(".chaty-channel").hasClass("chaty-cta-close")) {
                    if (t("#chaty-form-" + o + "-Whatsapp").length && t("#chaty-form-" + o + "-Whatsapp").hasClass("active") && (a = R(o, "c-Whatsapp"), B(o) && 0 != o || !a || G(o, "c-Whatsapp")), a = R(o, "c-widget"), t("#chaty-widget-" + o).find(".ch-pending-msg").remove(), a && (G(o, "c-widget"), t(this).closest(".chaty-channel").hasClass("chaty-cta-main"))) {
                        n = [], t("#chaty-widget-" + o).hasClass("chaty-has-chat-view") ? t(".chaty-chat-view.chaty-chat-view-" + o + " .chaty-view-channels").find(".chaty-channel").each((function() {
                            c = t(this).data("channel"), (a = R(o, "v-" + c)) && void 0 !== c && (G(o, "v-" + c), n.push(c))
                    ...
                    t("#chaty-widget-" + o).find(".ch-pending-msg").remove(), a = R(o, "c-widget");
                    r = t("#chaty-widget-" + o).data("nonce");
                    a && (G(o, "c-widget"), i = 0, n = [], c = t(this).closest(".chaty-channel").data("channel"), (a = R(o, "c-" + c)) && (n.push(c), i = 1), h || t.ajax({
                        url: chaty_settings.ajax_url,
                        data: {
                            widgetId: o,
                            userId: l,
                ...
                } else if (t(this).hasClass("chaty-link") && (c = t(this).closest(".chaty-channel").data("channel"), a = R(o, "c-" + c))) {
                    G(o, "c-" + c);
                    r = t("#chaty-widget-" + o).data("nonce");
                    h || t.ajax({
                        url: chaty_settings.ajax_url,
                        ...
                        if ("" != googleV3Token && (googleV3Token = "", refreshG3Token()), t(".chaty-ajax-error-message").remove(), t(".chaty-ajax-success-message").remove(), t(".chaty-submit-button").attr("disabled", !1), 1 == e.status) {
                            ...
                            "yes" == e.close_form_after && setTimeout((function() {
                                if (t(".chaty-outer-forms.active").length) {
                                    ...
                                    B(e) && 0 != e || t("#chaty-widget-" + e).length && (t("#chaty-widget-" + e).removeClass("form-open"), t("body").removeClass("add-bg-blur-effect"), t(".chaty-outer-forms.active").removeClass("active"), t("#chaty-widget-" + e).find(".chaty-widget").hasClass("chaty-no-close-button") && t("#chaty-widget-" + e).find(".chaty-widget:not(.has-single)").addClass("chaty-open"))
                                }
