(function(T, b) {
    ...
    const vt = async (t, e, n) => {
        ...
        for (let m = 0; m < c.length; m++) {
            ...
            if (a = y != null ? y : a, d = g != null ? g : d, u = { ...u,
                    [p]: { ...u[p],
                        ...v
                    }
                }, x && h <= 50) {
    ...
    async function Q(t, e) {
        ...
        const {
            ...
            altBoundary: u = !1,
            padding: h = 0
        } = e, m = Ct(h), w = s[u ? f === "floating" ? "reference" : "floating" : f], y = I(await c.getClippingRect({
    ...
    function Rt(t, e, n) {
        return (t ? [...n.filter(o => F(o) === t), ...n.filter(o => F(o) !== t)] : n.filter(o => _(o) === o)).filter(o => t ? F(o) === t || (e ? Z(o) !== o : !1) : !0)
    }
    const kt = function(t) {
        return t === void 0 && (t = {}), {
            name: "autoPlacement",
            ...
            async fn(e) {
                ...
                const {
                    ...
                    autoAlignment: w = !0,
                    ...y
                } = t, g = Rt(m, w, p), v = await Q(e, y), x = (n = (i = d.autoPlacement) == null ? void 0 : i.index) != null ? n : 0, P = g[x];
                if (P == null) return {};
                const {
                    main: U,
                    cross: G
                } = it(P, a, await (u.isRTL == null ? void 0 : u.isRTL(h.floating)));
                if (f !== P) return {
                    x: s,
                    y: l,
                    reset: {
                ...
                const J = [v[_(P)], v[U], v[G]],
                    A = [...(o = (c = d.autoPlacement) == null ? void 0 : c.overflows) != null ? o : [], {
                        placement: P,
                        overflows: J
                    }],
                    D = g[x + 1];
                ...
                const V = A.slice().sort((k, j) => k.overflows[0] - j.overflows[0]),
                    $ = (r = V.find(k => {
                        let {
                            overflows: j
                        } = k;
        ...
        return t === void 0 && (t = {}), {
            ...
            async fn(e) {
                ...
                const {
                    ...
                    flipAlignment: h = !0,
                    ...m
                } = t, p = _(i), y = f || (p === r || !h ? [z(r)] : Tt(r)), g = [r, ...y], v = await Q(e, m), x = [];
                let P = ((n = o.flip) == null ? void 0 : n.overflows) || [];
                if (a && x.push(v[p]), d) {
                    const {
                        main: A,
                        cross: D
                    } = it(i, c, await (s.isRTL == null ? void 0 : s.isRTL(l.floating)));
                    x.push(v[A], v[D])
                }
                if (P = [...P, {
                        placement: i,
                    ...
                    switch (u) {
                        case "bestFit":
                            {
                                var J;
                                const $ = (J = P.map(N => [N, N.overflows.filter(k => k > 0).reduce((k, j) => k + j, 0)]).sort((N, k) => N[1] - k[1])[0]) == null ? void 0 : J[0].placement;$ && (V = $);
                                break
                            }
    ...
    async function St(t, e) {
        const {
            ...
            platform: i,
            elements: o
        } = t, c = await (i.isRTL == null ? void 0 : i.isRTL(o.floating)), r = _(n), s = F(n), l = H(n) === "x", a = ["left", "top"].includes(r) ? -1 : 1, d = c && l ? -1 : 1, f = typeof e == "function" ? e(t) : e;
        let {
            mainAxis: u,
            crossAxis: h,
            alignmentAxis: m
    ...
    function pt(t) {
        return O(t) === "html" ? t : t.assignedSlot || t.parentNode || (M(t) ? t.host : null) || S(t)
    }
    ...
    function tt(t) {
        ...
        return n && (O(n) === "html" || O(n) === "body" && C(n).position === "static" && !at(n)) ? e : n || Wt(t) || e
    }
    ...
    function Yt(t) {
        ...
        const r = [...n === "clippingAncestors" ? Xt(e) : [].concat(n), i],
            ...
            l = r.reduce((a, d) => {
                const f = wt(e, d, o);
                return a.top = W(f.top, a.top), a.right = ut(f.right, a.right), a.bottom = ut(f.bottom, a.bottom), a.left = W(f.left, a.left), a
            }, wt(e, s, o));
        return {
    ...
    function qt(t, e, n, i) {
        ...
        const {
            ...
            elementResize: r = !0,
            animationFrame: s = !1
        } = i, l = o && !s, a = c && !s, d = l || a ? [...B(t) ? q(t) : [], ...q(e)] : [];
        d.forEach(p => {
    ...
    const ne = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512"><!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M310.6 361.4c12.5 12.5 12.5 32.75 0 45.25C304.4 412.9 296.2 416 288 416s-16.38-3.125-22.62-9.375L160 301.3L54.63 406.6C48.38 412.9 40.19 416 32 416S15.63 412.9 9.375 406.6c-12.5-12.5-12.5-32.75 0-45.25l105.4-105.4L9.375 150.6c-12.5-12.5-12.5-32.75 0-45.25s32.75-12.5 45.25 0L160 210.8l105.4-105.4c12.5-12.5 32.75-12.5 45.25 0s12.5 32.75 0 45.25l-105.4 105.4L310.6 361.4z"/></svg>',
        yt = b.getPrefixedClasses("popupContainer", "closeButton");
    class xt {
        constructor(e, n) {
            this.isOpen = !1, this.externalEvents = new b.Events, this.options = { ...ee(n),
                ...b.getOptions(e)
            }, this.popupEl = document.createElement("div"), this.popupEl.classList.add(yt.popupContainer), this.popupEl.classList.add(this.options.theme), n.className && this.popupEl.classList.add(n.className), this.options.showCloseButton && (this.closeButton = document.createElement("button"), this.closeButton.type = "button", this.closeButton.classList.add(yt.closeButton), this.closeButton.innerHTML = ne, this.closeButton.addEventListener("click", () => {
                this.close()
            }), this.popupEl.appendChild(this.closeButton));
            const i = document.createElement("div");
            this.popupEl.appendChild(i), this.picker = b.createPicker({ ...this.options,
                rootElement: i
...
`,
    ...
    T.PopupPickerController = xt, T.createPopup = se, Object.defineProperties(T, {
        __esModule: {
            value: !0
        },
        [Symbol.toStringTag]: {
