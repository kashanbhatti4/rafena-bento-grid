var ye = (e, t, o) => {
    ...
    w = (e, t, o) => (ye(e, t, "read from private field"), o ? o.call(e) : t.get(e)),
    b = (e, t, o) => {
        if (t.has(e)) throw TypeError("Cannot add the same private member more than once");
        t instanceof WeakSet ? t.add(e) : t.set(e, o)
    },
    J = (e, t, o, i) => (ye(e, t, "write to private field"), i ? i.call(e, o) : t.set(e, o), o),
    v = (e, t, o) => (ye(e, t, "access private method"), o);
! function(e, t) {
    "object" == typeof exports && typeof module < "u" ? t(exports) : "function" == typeof define && define.amd ? define(["exports"], t) : t((e = typeof globalThis < "u" ? globalThis : e || self).picmo = {})
}(this, (function(e) {
        var t, o, i, s, r, a, n, c, l, h, d, m, u, p;
        async function g(e, t = {}) {
            ...
            }(e, i, s), n = o ? localStorage : sessionStorage, c = `emojibase/${i}/${e}`, l = n.getItem(c);
        ...
        async function f(e, t, o) {
            var i;
            return g(`${e}/shortcodes/${null!==(i=y[t])&&void 0!==i?i:t}.json`, o)
        }
        ...
        async function C(e, t = {}) {
            const {
                ...
                shortcodes: s = [],
                ...r
            } = t, a = await g(`${e}/${o?"compact":"data"}.json`, r);
            let n = [];
            return s.length > 0 && (n = await Promise.all(s.map((t => {
                let o;
                if (t.includes("/")) {
                    const [e, i] = t.split("/");
                    o = f(e, i, r)
                ...
                return e.forEach((e => {
                    if (e.skins) {
                        ...
                        o.push(j(s, t)), i.forEach((e => {
                            const i = { ...e
                            };
                            s.tags && (i.tags = [...s.tags]), o.push(j(i, t))
                        }))
                    } else o.push(j(e, t))
                })), o
            }(a, n) : function(e, t) {
        ...
        function x(e) {
            var t;
            const o = null == (t = window.matchMedia) ? void 0 : t.call(window, "(prefers-reduced-motion: reduce)");
            return e.animate && !(null != o && o.matches)
        }
        ...
        function P(e, t, o, i) {
            if (x(i) && e.animate) return e.animate(t, o).finished;
            const s = "normal" === o.direction ? 1 : 0,
                r = Object.entries(t).reduce(((e, [t, o]) => ({ ...e,
                    [t]: o[s]
                })), {});
            return Object.assign(e.style, r), Promise.resolve()
        }

        function L(e) {
            var t;
            const o = document.createElement("template");
            return o.innerHTML = e, null == (t = o.content) ? void 0 : t.firstElementChild
        }
        async function F(e) {
        ...
        function D(e) {
            ...
            return {
                ...
                label: e.label,
                tags: e.tags,
                skins: null == (t = e.skins) ? void 0 : t.map((e => D(e))),
                order: e.order,
                custom: !1,
                hexcode: e.hexcode,
                version: e.version
        ...
        function B(e, t, o) {
            var i;
            return !(o && !o.some((t => t.order === e.group))) && (E(e.label, t) || (null == (i = e.tags) ? void 0 : i.some((e => E(e, t)))))
        }
        class N {
            constructor(e = "en") {
                this.locale = e
        ...
        const H = [(e, t) => ("1F91D" === e.hexcode && t < 14 && (e.skins = []), e), (e, t) => (e.skins && (e.skins = e.skins.filter((e => !e.version || e.version <= t))), e)];

        function O(e, t) {
            return e.filter((e => null !== function(e, t) {
                return H.some((o => null === o(e, t))) ? null : e
            }(e, t)))
        }
        const K = {};

        function U(e) {
            return K[e] || (K[e] = new W(e)), K[e]
        }
        U.deleteDatabase = e => {};
        class W extends N {
            open() {
            ...
            getCategories(e) {
                ...
                if (e.showRecents && o.unshift({
                        key: "recents",
                        order: -1
                    }), null != (t = e.custom) && t.length && o.push({
                        key: "custom",
                        order: 10
                    }), e.categories) {
            ...
            getEmojis(e, t) {
                const o = this.emojis.filter((t => t.group === e.order)).filter((e => e.version <= t)).sort(((e, t) => null != e.order && null != t.order ? e.order - t.order : 0)).map(D);
                return Promise.resolve(O(o, t))
            }
            searchEmojis(e, t, o, i) {
                const s = this.emojis.filter((t => B(t, e, i) && t.version <= o)).map(D),
                    r = t.filter((t => B(t, e, i))),
                    a = [...O(s, o), ...r];
        ...
        async function G(e, t, o) {
            ...
            try {
                ...
                console.warn("[picmo] IndexedDB not available, falling back to InMemoryStoreFactory"), i = U(e)
            }
            return i
        }
        async function Z(e, t, o) {
            if (!V() && typeof window < "u") throw new Error("Session storage is required to use CDN emoji data.");
            const i = await G(e, t, o),
                [s, r] = await
            function(e) {
                const {
                    emojisUrl: t,
                ...
                try {
                    return Promise.all([q(t), q(o)])
                } catch {
                    return Promise.all([null, null])
                }
            }(e);
            if (await i.isPopulated()) s && r && await async function(e, t, o) {
                let i;
                try {
                    i = await e.getEtags()
                } catch {
                ...
                if (o !== r || t !== s) {
                    const [i, s] = await Promise.all([k(e.locale), C(e.locale)]);
                    await e.populate({
                        groups: i.groups,
                        emojis: s,
                        emojisEtag: t,
                ...
                const [t, o] = await Promise.all([k(e), C(e)]);
                await i.populate({
                    groups: t.groups,
                    emojis: o,
                    emojisEtag: s,
        ...
        async function Y(e, t, o, i, s) {
            return o && i ? async function(e, t, o, i, s) {
                const r = await G(e, t, s),
                    a = await F(i);
                return (!await r.isPopulated() || await async function(e, t) {
                    return t !== await e.getHash()
                }(r, a)) && await r.populate({
                    groups: o.groups,
                    emojis: i,
                    hash: a
                }), r
        ...
        class Q {
            ...
            deactivate() {
                var e;
                null == (e = this.rootElement) || e.removeEventListener("keydown", this.handleKeyDown)
            }
        ...
        class oe {
            ...
            bindUIElements() {
                this.ui = Object.keys(this.uiElements).reduce(((e, t) => ({ ...e,
            ...
            scheduleShowAnimation() {
                if (this.parent) {
                    const e = new MutationObserver((t => {
                        const [o] = t;
                        "childList" === o.type && o.addedNodes[0] === this.el && (x(this.options) && this.animateShow && this.animateShow(), e.disconnect)
                    }));
        ...
        function re(e, t) {
            if (!(e in ie)) return console.warn(`Unknown icon: "${e}"`), document.createElement("div");
        ...
        class ne {
            constructor(e, s = {}) {
                b(this, i), b(this, r), b(this, n), b(this, t, void 0), b(this, o, void 0), J(this, t, e), J(this, o, s.mode || ae)
            }
            renderSync(e = {}) {
                const o = L(w(this, t).call(this, e));
                return v(this, n, c).call(this, o, e), v(this, r, a).call(this, o), v(this, i, s).call(this, o, e), o
            }
            async renderAsync(e = {}) {
                const o = L(w(this, t).call(this, e));
                return v(this, n, c).call(this, o, e), v(this, r, a).call(this, o), await v(this, i, s).call(this, o, e), o
            }
            render(e) {
                return "sync" === w(this, o) ? this.renderSync(e) : this.renderAsync(e)
            }
        }
        t = new WeakMap, o = new WeakMap, i = new WeakSet, s = async function(e, t) {
            const o = e.querySelectorAll("[data-view]"),
                i = [];
            for (const e of o) {
                const o = t[e.dataset.view];
                o ? "sync" !== e.dataset.render ? i.push(o.render().then((t => (e.replaceWith(t), t)))) : e.replaceWith(o.renderSync()) : e.remove()
            }
            return Promise.all(i)
        }, r = new WeakSet, a = function(e) {
            e.querySelectorAll("i[data-icon]").forEach((e => {
                const {
                    icon: t,
                    size: o
                } = e.dataset;
                e.replaceWith(re(t, o))
            }))
        }, n = new WeakSet, c = function(e, t) {
        ...
        const ce = $("imagePlaceholder", "placeholder"),
            le = new ne((({
                classes: e
        ...
        class me {
            ...
            doRender(e, t, o) {
                ...
                const {
                    content: i,
                    resolver: s
                } = this.render(e, o), r = i instanceof Element ? i : i.el;
                return s && s(), r
            }
            doEmit(e) {
            ...
            renderCustom(e, t, o = "") {
                const i = [de.customEmoji, o].join(" ").trim(),
                    {
                        content: s,
                        resolver: r
        ...
        class pe extends me {
            render(e) {
                return this.renderElement(ue.renderSync({
                    emoji: e.emoji
                }))
            }
            emit({
        ...
        ve.deleteDatabase = e => new Promise(((t, o) => {
            const i = indexedDB.deleteDatabase(`${ye}-${e}`);
            i.addEventListener("success", t), i.addEventListener("error", o)
        }));
        class fe extends N {
            async open() {
                const e = indexedDB.open(`${ye}-${this.locale}`);
                return new Promise(((t, o) => {
                    e.addEventListener("success", (e => {
                        var o;
                        this.db = null == (o = e.target) ? void 0 : o.result, t()
                    })), e.addEventListener("error", o), e.addEventListener("upgradeneeded", (async e => {
                        var t;
                        this.db = null == (t = e.target) ? void 0 : t.result, this.db.createObjectStore("category", {
                            keyPath: "order"
                        });
            ...
            async delete() {
                this.close();
                const e = indexedDB.deleteDatabase(`${ye}-${this.locale}`);
            ...
            async getEtags() {
                const e = this.db.transaction("meta", "readonly").objectStore("meta"),
                    [t, o] = await Promise.all([this.waitForRequest(e.get("emojisEtag")), this.waitForRequest(e.get("messagesEtag"))]);
                return {
            ...
            async setMeta(e) {
                ...
                return new Promise((i => {
                    t.oncomplete = i, Object.keys(e).filter(Boolean).forEach((t => {
                        o.put(e[t], t)
                    }))
                }))
            }
            ...
            async populate({
                ...
                const r = [this.addObjects("category", e), this.addObjects("emoji", t), this.setMeta({
                    emojisEtag: o,
                    messagesEtag: i,
                    hash: s
                })];
            ...
            async getCategories(e) {
                ...
                let i = (await this.waitForRequest(o.getAll())).target.result.filter((e => "component" !== e.key));
                if (e.showRecents && i.unshift({
                        key: "recents",
                        order: -1
                    }), null != (t = e.custom) && t.length && i.push({
                        key: "custom",
                        order: 10
                    }), e.categories) {
                    const t = e.categories;
                    i = i.filter((e => t.includes(e.key))), i.sort(((e, o) => t.indexOf(e.key) - t.indexOf(o.key)))
                } else i.sort(((e, t) => e.order - t.order));
                return i
            }
            async getEmojis(e, t) {
                const o = this.db.transaction("emoji", "readonly").objectStore("emoji").index("category");
                return O((await this.waitForRequest(o.getAll(e.order))).target.result.filter((e => e.version <= t)).sort(((e, t) => null != e.order && null != t.order ? e.order - t.order : 0)).map(D), t)
            }
            async searchEmojis(e, t, o, i) {
                const s = [];
                return new Promise(((r, a) => {
                    const n = this.db.transaction("emoji", "readonly").objectStore("emoji").openCursor();
                    n.addEventListener("success", (a => {
                        var n;
                        const c = null == (n = a.target) ? void 0 : n.result;
                        if (!c) return r([...O(s, o), ...t.filter((t => B(t, e)))]);
                        const l = c.value;
                        B(l, e, i) && l.version <= o && s.push(D(l)), c.continue()
            ...
            withTransaction(e, t = "readwrite", o) {
                return new Promise(((i, s) => {
                    const r = this.db.transaction(e, t);
                    r.oncomplete = i, r.onerror = s, o(r)
                }))
            }
            async removeAllObjects(...e) {
                const t = this.db.transaction(e, "readwrite"),
                    o = e.map((e => t.objectStore(e)));
                await Promise.all(o.map((e => this.waitForRequest(e.clear()))))
            }
        ...
        class be {}
        const je = "PicMo:recents";
        class Ce extends be {
            constructor(e) {
                super(), this.storage = e
            }
            clear() {
                this.storage.removeItem(je)
            }
            getRecents(e) {
                var t;
                try {
                    return JSON.parse(null != (t = this.storage.getItem(je)) ? t : "[]").slice(0, e)
                } catch {
                    return []
                }
            }
            addOrUpdateRecent(e, t) {
                const o = [e, ...this.getRecents(t).filter((t => t.hexcode !== e.hexcode))].slice(0, t);
                try {
                    this.storage.setItem(je, JSON.stringify(o))
                } catch {
        ...
        function xe(e = {}) {
            return { ..._e,
                ...e,
                renderer: e.renderer || new pe,
                recentsProvider: e.recentsProvider || new ke
            }
        }
        class Ee {
            constructor() {
                b(this, h), b(this, m), b(this, l, new Map)
            }
            on(e, t, o) {
                v(this, m, u).call(this, e, t, o)
            }
            once(e, t, o) {
                v(this, m, u).call(this, e, t, o, !0)
            }
            off(e, t) {
                const o = v(this, h, d).call(this, e);
                w(this, l).set(e, o.filter((e => e.handler !== t)))
            }
            emit(e, ...t) {
                v(this, h, d).call(this, e).forEach((o => {
        ...
        l = new WeakMap, h = new WeakSet, d = function(e) {
            return w(this, l).has(e) || w(this, l).set(e, []), w(this, l).get(e)
        }, m = new WeakSet, u = function(e, t, o, i = !1) {
            v(this, h, d).call(this, e).push({
                context: o,
                handler: t,
                once: i
            })
        ...
        class ze extends Ee {}
        class Pe extends Ee {}
        const Le = $("emojiCategory", "categoryName", "noRecents", "recentEmojis");
        class Fe extends oe {
            constructor({
                template: e,
                category: t,
                ...
                super({
                    ...
                    categoryName: oe.byClass(Le.categoryName)
        ...
        class Ie extends oe {
            ...
            initialize() {
                this.uiEvents = [oe.uiEvent("focus", this.handleFocus)], super.initialize()
            }
            handleFocus() {
        ...
        class Te {
            constructor(e, t, o = 0, i = 0, s = !1) {
                this.events = new Ee, this.keyHandlers = {
        ...
        class Re extends oe {
            constructor({
                ...
                super({
                    template: Me,
                    classes: Ve
                }), this.fullHeight = !1, this.showVariants = t, this.lazyLoader = i, this.preview = o, this.emojis = e, this.category = s, this.fullHeight = r, this.setFocus = this.setFocus.bind(this), this.triggerNextCategory = this.triggerNextCategory.bind(this), this.triggerPreviousCategory = this.triggerPreviousCategory.bind(this)
            }
            initialize() {
                this.grid = new Te(this.options.emojisPerRow, this.emojiCount, 0, 0, !this.category), this.grid.on("focus:change", this.setFocus), this.grid.on("focus:overflow", this.triggerNextCategory), this.grid.on("focus:underflow", this.triggerPreviousCategory), this.uiEvents = [oe.uiEvent("click", this.selectEmoji), oe.uiEvent("keydown", this.grid.handleKeyDown)], this.preview && this.uiEvents.push(oe.uiEvent("mouseover", this.showPreview), oe.uiEvent("mouseout", this.hidePreview), oe.uiEvent("focus", this.showPreview, {
                    capture: !0
                }), oe.uiEvent("blur", this.hidePreview, {
                    capture: !0
                })), super.initialize()
            }
            setFocusedView(e, t) {
                if (e)
                    if ("string" == typeof e) {
                        ...
                        this.grid.setFocusedIndex(t, !1), setTimeout((() => {
                            var e, o, i, s;
                            const r = this.emojiViews[t].el;
                            r.scrollIntoView();
                            const a = null == (e = r.parentElement) ? void 0 : e.previousElementSibling;
                            (null == (i = null == (o = r.parentElement) ? void 0 : o.parentElement) ? void 0 : i.parentElement).scrollTop -= null != (s = null == a ? void 0 : a.offsetHeight) ? s : 0
                        }))
                    } else "first" === e.row || 0 === e.row ? this.grid.setCell(0, e.offset, t) : "last" === e.row && this.grid.setCell(this.grid.getRowCount() - 1, e.offset, t)
            }
            setActive(e, t, o) {
                var i;
                e ? this.setFocusedView(t, o) : null == (i = this.emojiViews[this.grid.getIndex()]) || i.deactivateFocus()
            }
            renderSync() {
                return this.emojiViews = this.emojis.map((e => this.viewFactory.create(Ie, {
                    emoji: e,
            ...
            setFocus({
                ...
                var i, s;
                null == (i = this.emojiViews[e]) || i.deactivateFocus(), null == (s = this.emojiViews[t]) || s.activateFocus(o)
            }
            selectEmoji(e) {
                e.stopPropagation();
                const t = _(e, this.emojis);
            ...
            hidePreview(e) {
                _(e, this.emojis) && this.events.emit("preview:hide")
            }
            get emojiCount() {
        ...
        class Be extends Fe {
            ...
            async render() {
                ...
                return this.emojiContainer = this.viewFactory.create(Re, {
                    emojis: e,
                    showVariants: this.showVariants,
                    lazyLoader: this.lazyLoader,
        ...
        class Ne extends Re {
            ...
            async addOrUpdate(e) {
                ...
                t && (this.el.removeChild(t), this.emojis = this.emojis.filter((t => t !== e)));
                const o = this.viewFactory.create(Ie, {
                    emoji: e
                });
                if (this.el.insertBefore(o.renderSync(), this.el.firstChild), this.emojis = [e, ...this.emojis.filter((t => t !== e))], this.emojis.length > this.options.maxRecents) {
        ...
        const Ue = $("emojiArea"),
            ...
            qe = {
                recents: class extends Fe {
                    ...
                    initialize() {
                        this.uiElements = { ...this.baseUIElements,
                            recents: oe.byClass(Le.recentEmojis)
                        }, this.appEvents = {
                    ...
                    async render() {
                        var e;
                        const t = null == (e = this.provider) ? void 0 : e.getRecents(this.options.maxRecents);
                        return this.emojiContainer = this.viewFactory.create(Ne, {
                            emojis: t,
                            showVariants: !1,
                            lazyLoader: this.lazyLoader,
                            category: this.category.key
        ...
        class Ge extends oe {
            constructor({
                ...
                super({
                    template: We,
                    classes: Ue
                }), this.selectedCategory = 0, this.scrollListenerState = "active", this.lazyLoader = new Ke, this.categoryTabs = e, this.categories = t, this.emojiVersion = o, this.handleScroll = S(this.handleScroll.bind(this), 100)
            }
            initialize() {
                this.appEvents = {
                    ...
                    emojis: oe.byClass(Ue.emojiArea)
                }, this.uiEvents = [oe.uiEvent("scroll", this.handleScroll)], super.initialize()
            }
            get focusableEmoji() {
            ...
            async render() {
                ...
                return this.categories.forEach(((t, o) => {
                    ...
                    emojis: await Promise.all(this.emojiCategories.map((e => e.render())))
                }), this.lazyLoader.observe(this.el), this.el
            }
            destroy() {
                super.destroy(), this.emojiCategories.forEach((e => {
                    var t;
                    null == (t = this.observer) || t.unobserve(e.el), e.destroy()
                }))
            }
            ...
            determineInitialCategory() {
                var e;
                return this.options.initialCategory && this.categories.find((e => e.key === this.options.initialCategory)) ? this.options.initialCategory : null == (e = this.categories.find((e => "recents" !== e.key))) ? void 0 : e.key
            }
            ...
            async selectCategory(e, t = {}) {
                ...
                const a = this.selectedCategory = "number" == typeof e ? e : this.getCategoryIndex(e);
                null == (o = this.categoryTabs) || o.setActiveTab(this.selectedCategory, {
                    performFocus: s,
                    scroll: "button" === i
                });
                const n = this.emojiCategories[a].el.offsetTop;
                var c;
                this.emojiCategories[a].setActive(!0, (c = i) && "button" !== c ? c : {
                    row: "first",
                    offset: 0
                }, "button" !== i && s), r && (this.el.scrollTop = n), this.scrollListenerState = "resume"
            }
            updateFocusedCategory(e) {
                var t;
                this.categories[this.selectedCategory].key !== e && (this.scrollListenerState = "suspend", this.selectedCategory = this.getCategoryIndex(e), null == (t = this.categoryTabs) || t.setActiveTab(this.selectedCategory, {
                    changeFocusable: !1,
                    performFocus: !1
            ...
            handleScroll() {
                ...
                const e = this.el.scrollTop,
                    ...
                    o = this.emojiCategories.findIndex(((t, o) => {
                        var i;
                        return e < (null == (i = this.emojiCategories[o + 1]) ? void 0 : i.el.offsetTop)
                    })),
                    i = {
                        changeFocusable: !1,
                        performFocus: !1,
                ...
                0 === e ? this.categoryTabs.setActiveTab(0, i) : Math.floor(e) === Math.floor(t) || o < 0 ? this.categoryTabs.setActiveTab(this.categories.length - 1, i) : this.categoryTabs.setActiveTab(o, i)
            }
        }
        const Je = new ne((({
                classList: e,
        ...
        class Ye extends oe {
            ...
            renderSync() {
                const e = [Ze.error, this.className].join(" ").trim();
                return super.renderSync({
        ...
        class et extends Ye {
            constructor({
                ...
                super({
                    message: e,
                    template: Qe,
                    className: Xe.dataError
                })
            }
            initialize() {
                this.uiElements = {
                    retryButton: "button"
                }, this.uiEvents = [oe.childEvent("retryButton", "click", this.onRetry)], super.initialize()
            }
            async onRetry() {
        ...
        const tt = $("preview", "previewEmoji", "previewName", "tagList", "tag"),
            ot = new ne((({
                classes: e,
                tag: t
            }) => `\n  <li class="${e.tag}">${t}</li>\n`)),
        ...
        class st extends oe {
            ...
            initialize() {
                this.uiElements = {
                    emoji: oe.byClass(tt.previewEmoji),
                    name: oe.byClass(tt.previewName),
                    tagList: oe.byClass(tt.tagList)
                }, this.appEvents = {
            ...
            showPreview(e, t) {
                if (T(this.ui.emoji, t), this.ui.name.textContent = e.label, e.tags) {
                    this.ui.tagList.style.display = "flex";
                    const t = e.tags.map((e => ot.renderSync({
                        tag: e,
                        classes: tt
                    })));
                    T(this.ui.tagList, ...t)
            ...
            hidePreview() {
                I(this.ui.emoji), I(this.ui.name), I(this.ui.tagList)
            }
        }
        const rt = new ne((({
                classes: e,
            ...
            nt = $("searchContainer", "searchField", "clearButton", "searchAccessory", "clearSearchButton", "notFound");
        class ct extends oe {
            constructor({
                categories: e,
                emojiVersion: t
                ...
                super({
                    template: at,
                    classes: nt
                }), this.categories = e.filter((e => "recents" !== e.key)), this.emojiVersion = t, this.search = z(this.search.bind(this), 100)
            }
            initialize() {
                this.uiElements = {
                    searchField: oe.byClass(nt.searchField),
                    searchAccessory: oe.byClass(nt.searchAccessory)
                }, this.uiEvents = [oe.childEvent("searchField", "keydown", this.onKeyDown), oe.childEvent("searchField", "input", this.onSearchInput)], super.initialize()
            }
            async render() {
                return await super.render(), this.searchIcon = re("search"), this.notFoundMessage = this.viewFactory.create(Ye, {
                    message: this.i18n.get("search.notFound"),
                    className: nt.notFound,
                    icon: "sad"
                }), this.notFoundMessage.renderSync(), this.errorMessage = this.viewFactory.create(Ye, {
                    message: this.i18n.get("search.error")
                }), this.errorMessage.renderSync(), this.clearSearchButton = rt.render({
                    classes: nt,
                    i18n: this.i18n
            ...
            onClearSearch(e) {
                var t;
                e.stopPropagation(), this.searchField.value = "", null == (t = this.resultsContainer) || t.destroy(), this.resultsContainer = null, this.showSearchIcon(), this.events.emit("content:show"), this.searchField.focus()
            }
            ...
            onKeyDown(e) {
                var t;
                "Escape" === e.key && this.searchField.value ? this.onClearSearch(e) : ("Enter" === e.key || "ArrowDown" === e.key) && this.resultsContainer && (e.preventDefault(), null == (t = this.resultsContainer.el.querySelector('[tabindex="0"]')) || t.focus())
            }
            onSearchInput(e) {
            ...
            async search() {
                ...
                if (this.searchField.value) try {
                    ...
                    if (this.events.emit("preview:hide"), t.length) {
                        const o = new Ke;
                        this.resultsContainer = this.viewFactory.create(Re, {
                            emojis: t,
                            fullHeight: !0,
                            showVariants: !0,
                            lazyLoader: o
                        }), this.resultsContainer.renderSync(), null != (e = this.resultsContainer) && e.el && (o.observe(this.resultsContainer.el), this.resultsContainer.setActive(!0, {
                            row: 0,
                            offset: 0
        ...
        const lt = new ne((({
            ...
            ht = $("variantOverlay", "variantPopup"),
            dt = {
                easing: "ease-in-out",
                duration: 250,
                fill: "both"
        ...
        class pt extends oe {
            constructor({
                ...
                super({
                    ...
                    classes: ht,
                    parent: t
                }), this.focusedEmojiIndex = 0, this.focusTrap = new Q, this.animateShow = () => Promise.all([P(this.el, mt, dt, this.options), P(this.ui.popup, ut, dt, this.options)]), this.emoji = e
            }
            initialize() {
                this.uiElements = {
                    popup: oe.byClass(ht.variantPopup)
                }, this.uiEvents = [oe.uiEvent("click", this.handleClick), oe.uiEvent("keydown", this.handleKeydown)], super.initialize()
            }
            animateHide() {
                const e = { ...dt,
                    direction: "reverse"
                };
                return Promise.all([P(this.el, mt, e, this.options), P(this.ui.popup, ut, e, this.options)])
            }
            async hide() {
        ...
        const gt = new ne((({
            ...
            yt = $("categoryTab", "categoryTabActive", "categoryButton");
        class vt extends oe {
            constructor({
                category: e,
                icon: t
            ...
            initialize() {
                this.uiElements = {
                    button: oe.byClass(yt.categoryButton)
                }, this.uiEvents = [oe.childEvent("button", "click", this.selectCategory), oe.childEvent("button", "focus", this.selectCategory)], super.initialize()
            }
            renderSync() {
                return super.renderSync({
                    category: this.category,
            ...
            setActive(e, t = {}) {
                ...
                this.el.classList.toggle(yt.categoryTabActive, e), o && (this.ui.button.tabIndex = e ? 0 : -1, this.ui.button.ariaSelected = e.toString()), e && i && (this.ui.button.focus(), s && this.events.emit("category:select", this.category.key, {
                    scroll: "animate",
                    focus: "button",
                    performFocus: !1
                })), this.isActive = e
        ...
        class bt extends oe {
            ...
            initialize() {
                ...
                }, this.uiEvents = [oe.uiEvent("scroll", this.checkOverflow)], super.initialize()
            }
            checkOverflow() {
                const e = Math.abs(this.el.scrollLeft - (this.el.scrollWidth - this.el.offsetWidth)) > 1,
            ...
            renderSync() {
                return this.tabViews = this.categories.map((e => this.viewFactory.create(vt, {
                    category: e,
                    icon: se[e.key]
                }))), super.renderSync({
        ...
        function _t(e) {
            ...
            n < header class = "${o.headerSkeleton}" > \n $ {
                (({
                    showSearch: e,
                    classes: t
            ...
            n < /div>\n  `}const xt=new ne((e=>e.isLoaded?function(e){const{classes:t,theme:o,className:i=""}=e;return`\n    <div class="picmo__picker ${t.picker} ${o} ${i}">\n      ${function({showHeader:e,classes:t}){return e?`\n    <header class="${t.header}">\n      <div data-view="search"></div > \n < div data - view = "categoryTabs"
            data - render = "sync" > < /div>\n    </header > \n `:""}(e)}\n      <div class="${t.content}">\n        <div data-view="emojiArea"></div>\n      </div>\n      <div data-view="preview"></div>\n    </div>\n  `
        }(e): _t(e))), Et = $("picker", "skeleton", "placeholder", "searchSkeleton", "searchInput", "categoryTabsSkeleton", "headerSkeleton", "categoryTab", "contentSkeleton", "categoryName", "emojiGrid", "emoji", "previewSkeleton", "previewEmoji", "previewName", "tagList", "tag", "overlay", "content", "fullHeight", "pluginContainer", "header"), St = {
        ...
        constructor() {
            super({
                template: xt,
                classes: Et
            }), this.pickerReady = !1, this.externalEvents = new Pe, this.updaters = {
                styleProperty: e => t => this.el.style.setProperty(St[e], t.toString()),
                theme: e => {
                    const t = this.options.theme,
                        o = this.el.closest(`.${t}`);
                    this.el.classList.remove(t), null == o || o.classList.remove(t), this.el.classList.add(e), null == o || o.classList.add(e)
                },
                className: e => {
        ...
        initialize() {
            this.uiElements = {
                pickerContent: oe.byClass(Et.content),
                header: oe.byClass(Et.header)
            }, this.uiEvents = [oe.uiEvent("keydown", this.handleKeyDown)], this.appEvents = {
                error: this.onError,
        ...
        destroy() {
            var e, t;
            super.destroy(), null == (e = this.search) || e.destroy(), this.emojiArea.destroy(), null == (t = this.categoryTabs) || t.destroy(), this.events.removeAll(), this.externalEvents.removeAll()
        }
        clearRecents() {
        ...
        buildChildViews() {
            return this.options.showPreview && (this.preview = this.viewFactory.create(st)), this.options.showSearch && (this.search = this.viewFactory.create(ct, {
                categories: this.categories,
                emojiVersion: this.emojiVersion
            })), this.options.showCategoryTabs && (this.categoryTabs = this.viewFactory.create(bt, {
                categories: this.categories
            })), this.currentView = this.emojiArea = this.viewFactory.create(Ge, {
        ...
        setStyleProperties() {
            this.options.showSearch || this.el.style.setProperty("--search-height-full", "0px"), this.options.showCategoryTabs || (this.el.style.setProperty("--category-tabs-height", "0px"), this.el.style.setProperty("--category-tabs-offset", "0px")), this.options.showPreview || this.el.style.setProperty("--emoji-preview-height-full", "0px"), Object.keys(St).forEach((e => {
                this.options[e] && this.el.style.setProperty(St[e], this.options[e].toString())
            }))
        }
        updateStyleProperty(e, t) {
            this.el.style.setProperty(St[e], t.toString())
        }
        reinitialize() {
            this.renderSync()
        }
        onError(e) {
            const t = this.viewFactory.createWithOptions({
                    data: !1
                }, et, {
                    message: this.i18n.get("error.load")
                }),
                o = this.el.offsetHeight || 375;
            throw this.el.style.height = `${o}px`, T(this.el, t.renderSync()), e
        }
        async onDataReady(e) {
            const t = this.el;
            try {
                e ? this.emojiData = e : await this.emojiDataPromise, "auto" === this.options.emojiVersion ? this.emojiVersion = Ct() || parseFloat("14.0") : this.emojiVersion = this.options.emojiVersion, this.categories = await this.emojiData.getCategories(this.options);
                const [o, i, s, r] = this.buildChildViews();
                await super.render({
                    isLoaded: !0,
                    search: i,
                    categoryTabs: r,
        ...
        renderSync() {
            var e;
            let t = (null == (e = this.options.categories) ? void 0 : e.length) || 10;
            if (this.options.showRecents && (t += 1), super.renderSync({
                    isLoaded: !1,
                    theme: this.options.theme,
                    className: this.options.className,
                    ...
                    categoryCount: t
                }), this.el.style.setProperty("--category-count", t.toString()), !this.options.rootElement) throw new Error("Picker must be given a root element via the rootElement option");
            return T(this.options.rootElement, this.el), this.setStyleProperties(), this.pickerReady && this.initializePickerView(), this.el
        }
        getInitialFocusTarget() {
            ...
            if (!0 === this.options.autoFocusSearch) return console.warn("options.autoFocusSearch is deprecated, please use options.focusTarget instead"), this.search
        }
        setInitialFocus() {
            var e;
            !this.pickerReady || null == (e = this.getInitialFocusTarget()) || e.focus()
        }
        reset(e = !0) {
            var t;
            this.pickerReady && (this.emojiArea.reset(e), this.showContent(this.emojiArea)), null == (t = this.search) || t.clear(), this.hideVariantPopup()
        }
        showContent(e = this.emojiArea) {
            var t, o;
            e !== this.currentView && (this.currentView !== this.emojiArea && (null == (t = this.currentView) || t.destroy()), this.ui.pickerContent.classList.toggle(Et.fullHeight, e !== this.emojiArea), T(this.ui.pickerContent, e.el), this.currentView = e, e === this.emojiArea ? (this.emojiArea.reset(), this.categoryTabs && this.ui.header.appendChild(this.categoryTabs.el)) : null == (o = this.categoryTabs) || o.el.remove())
        }
        hideVariantPopup() {
            var e;
            null == (e = this.variantPopup) || e.destroy()
        }
        isPickerClick(e) {
            var t, o;
            const i = e.target,
                s = this.el.contains(i),
                r = null == (o = null == (t = this.variantPopup) ? void 0 : t.el) ? void 0 : o.contains(i);
            return s || r
        }
        async selectEmoji({
            emoji: e
            ...
            var t, o;
            (null == (t = e.skins) ? void 0 : t.length) && this.options.showVariants && !this.isVariantPopupOpen ? this.showVariantPopup(e) : (await (null == (o = this.variantPopup) ? void 0 : o.animateHide()), this.events.emit("variantPopup:hide"), await this.emitEmoji(e))
        }
        ...
        async showVariantPopup(e) {
            ...
            this.events.once("variantPopup:hide", (() => {
                null == t || t.focus()
            })), this.variantPopup = this.viewFactory.create(pt, {
                emoji: e,
                parent: this.el
    ...
    class Pt {
        constructor({
            ...
            this.events = e, this.i18n = t, this.renderer = o, this.emojiData = i, this.options = s, this.customEmojis = r, this.pickerId = a
        }
        setEmojiData(e) {
        ...
        createWithOptions(e = {}, t, ...o) {
            const i = new t(...o);
            return i.setPickerId(this.pickerId), i.setEvents(this.events), i.setI18n(this.i18n), i.setRenderer(this.renderer), !1 !== e.data && i.setEmojiData(this.emojiData), i.setOptions(this.options), i.setCustomEmojis(this.customEmojis), i.viewFactory = this, i.initialize(), i
        }
        create(e, ...t) {
    ...
    class Lt {
        constructor(e = {}) {
            b(this, p, void 0), J(this, p, new Map(Object.entries(e)))
        }
        get(e, t = e) {
            return w(this, p).get(e) || t
        }
    }
    ...
    function Ft() {
        let e = !1;
        return function(t) {
            Se.injectStyles && !e && (function(e, t) {
                void 0 === t && (t = {});
                var o = t.insertAt;
    ...
    const Tt = Object.freeze(Object.defineProperty({
        ...
        value: "Module"
    })); e.EmojiPicker = zt, e.Events = Ee, e.FocusTrap = Q, e.InMemoryProvider = class extends be {
        constructor() {
        ...
        const r = new Pt({
            ...
            options: t,
            emojiData: $t,
            pickerId: `picmo-${Date.now()}-${At++}`
        }).create(zt);
        return r.renderSync(), r
    }, e.createStyleInjector = Ft, e.darkTheme = ee, e.debounce = z, e.deleteDatabase = function(e, t) {
        e.deleteDatabase(t)
    }, e.empty = I, e.en = ge, e.getEmojiForEvent = _, e.getOptions = xe, e.getPrefixedClasses = $, e.globalConfig = Se, e.i18n = Tt, e.isLocalStorageAvailable = R, e.isSessionStorageAvailable = V, e.lightTheme = X, e.prefixClassName = A, e.replaceChildren = T, e.shouldAnimate = x, e.throttle = S, e.toElement = L, Object.defineProperties(e, {
        __esModule: {
            value: !0
        },
        [Symbol.toStringTag]: {
