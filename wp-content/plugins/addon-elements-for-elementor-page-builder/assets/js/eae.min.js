jQuery(window).on("elementor/frontend/init", function() {
    elementorFrontend.hooks.addAction("frontend/element_ready/wts-gmap.default", function(e) {
            ...
            return s.markers = [], i.each(function() {
                    ! function(a, n) {
                        ...
                        if (n.markers.push(s), a.html()) {
                            ...
                            "yes" == a.data("info-window") && l.open(n, s), google.maps.event.addListener(s, "click", function() {
                                l.open(n, s)
                            })
                        }
                        "animate-yes" == i && google.maps.event.addListener(l, "closeclick", function() {
        ...
        var t, a, n, i, r, o, s, l = [],
            ...
            c = e.data("id"),
            p = e.data("eae-slider"),
            f = jQuery(".elementor-element-" + c + "[data-eae-slider='" + p + "']").children(".aepro-section-bs").children(".aepro-section-bs-inner");
        f && f.data("eae-bg-slider") && (slider_images = f.data("eae-bg-slider"), t = f.data("eae-bg-slider-transition"), a = f.data("eae-bg-slider-animation"), i = ("yes" == (n = f.data("eae-bg-custom-overlay")) || f.data("eae-bg-slider-overlay"), eae_editor.plugin_url + "assets/lib/vegas/overlays/" + f.data("eae-bg-slider-overlay")), r = f.data("eae-bg-slider-cover"), o = f.data("eae-bs-slider-delay"), s = f.data("eae-bs-slider-timer"), "undefined" != typeof slider_images && (l = slider_images.split(","), jQuery.each(l, function(e, t) {
            var a = [];
            a.src = t, d.push(a)
        }), f.vegas({
            slides: d,
            ...
            timer: s,
            init: function() {
                "yes" == n && f.children(".vegas-overlay").css("background-image", "")
            }
        })))
    })
});
    ...
    e(window).on("elementor/frontend/init", function() {
        var t = function(e) {
            ...
            n = function(e, t) {
                ...
                n.querySelector(".eae-pb-inner-line"), s[s.length - 1].getBoundingClientRect().bottom;

                function d() {
                    const e = o[0].getBoundingClientRect(),
                        t = (o[o.length - 1].getBoundingClientRect(), s[0].getBoundingClientRect().bottom - e.top),
                        a = s[0].getBoundingClientRect(),
                        n = s[0].offsetLeft + s[0].offsetWidth / 2,
                        i = s[s.length - 1].getBoundingClientRect();
                    l.style.height = i.top - a.bottom + "px", l.style.top = t + "px", l.style.left = n + "px", l.style.display = "block"
                }
                ...
                function c() {
                    ...
                    t > a ? (e.style.height = t - a + "px", o.forEach((e, a) => {
                        let n = e.getBoundingClientRect().top + window.scrollY;
                        t > n ? e.classList.add("eae-tl-item-focused") : e.classList.remove("eae-tl-item-focused")
                    })) : o[0].classList.remove("eae-tl-item-focused")
                }
                d(), c(), window.addEventListener("resize", () => {
                    d()
        ...
        var o = function(e, t) {
                ...
                var a = $wrapper.attr("data-value"),
                    ...
                    i = ($wrapper.find(".eae-pb-bar-skill"), $wrapper.find(".eae-pb-bar-value")),
                    ...
                    const n = new IntersectionObserver(e => {
                        e.forEach(e => {
                            ...
                            if (e.isIntersecting) {
                                ...
                                null == t || t.classList.contains("js-animated") || t.classList.add("js-animated"), null == a || a.classList.contains("js-animated") || a.classList.add("js-animated"), null == n || n.classList.contains("js-animated") || n.classList.add("js-animated")
                            } else e.isIntersecting || e.target.classList.remove("animate");
                            a = t
                        })
                    }, {
                        root: null,
            ...
            l = function(e, t) {
                ...
                function c(e) {
                    e ? (o.addClass("active"), d.addClass("active"), i.removeClass("active"), l.removeClass("active")) : (i.addClass("active"), l.addClass("active"), o.removeClass("active"), d.removeClass("active")), a.find("input.eae-content-toggle-switch").prop("checked", !!e), window.dispatchEvent(new Event("resize"))
                }
                t(n).on("click", function(e) {
                    e.preventDefault();
                    c(!t(this).find("input.eae-content-toggle-switch").is(":checked"))
        ...
        let d = function(e, t) {
            ...
            new IntersectionObserver((e, t) => {
                e.forEach(e => {
                    const a = e.target;
                    e.isIntersecting && (a.classList.contains("trigger") || (a.classList.add("trigger"), new Chart(r, o)), t.unobserve(a))
                })
            }, {
                root: null,
                threshold: .3
        ...
        const c = function(e, t, a = null, n) {
                ...
                if (null !== a) {
                    t = a.data("id");
                    o = d + ' .eae-swiper-container[data-eae-slider-id="' + a.find(".swiper-container").data("eae-slider-id") + '"]'
                }
                if ("yes" === n.data("show-thumbnail")) {
                    ...
                    }(s, l, n.data("thumb-settings"), e.breakpoints_value), i.el = jQuery(".elementor-element-" + t + " .eae-thumb-container")
                }
                ...
                e.loop && e.hasOwnProperty("slidersPerView") && document.querySelectorAll(d + " .eae-swiper-slide").length < e.slidesPerView.tablet && (r.loop = !1);
                const c = {};
                if (e.hasOwnProperty("breakpoints_value") && Object.keys(e.breakpoints_value).map(t => {
                    ...
                    }), r.breakpoints = c, r.keyboard = "yes" === e.keyboard && {
                        enabled: !0,
                        onlyInViewport: !0
        ...
        var u, m = function(e) {
            ...
            g = elementorModules.frontend.handlers.Base;
        u = g.extend({
            ...
            onInit: function() {
                ...
                if ("pop" == t.sta_layout && "" != t.dynamic_coupon) {
                    const x = a.querySelector(".eae-coupon-popup-link"),
                        S = n.getAttribute("data-id");
                    "svg" == t.pop_icon.library ? ($close_btn_html = "", $close_btn_html = '<svg class="eae-close" style="-webkit-mask-image: url(' + m(t.pop_icon.value.url) + "); mask-image: url(" + m(t.pop_icon.value.url) + '); "></svg>') : $close_btn_html = '<i class="eae-close ' + m(t.pop_icon.value) + '"> </i>', e(x).eaePopup({
                        type: "inline",
                        midClick: !0,
                        mainClass: "eae-coupon-popup eae-popup  eae-cc-" + S,
                        closeMarkup: $close_btn_html,
                        closeBtnInside: "yes" == t.btn_in_out,
                        callbacks: {
                            beforeOpen: function() {
                                "" != t.effect && (this.st.mainClass = " eae-coupon-popup eae-popup  eae-cc-" + S + " mfp-" + t.effect)
                            },
                            open: function() {
                                var e = x.getAttribute("data-id");
                    ...
                    }), "yes" == t.preview_modal && elementorFrontend.isEditMode() && x.click()
                }
                if ("slide" == t.coupon_type && "" != t.dynamic_coupon) {
                    ...
                    if ("yes" == t.preview_modal && elementorFrontend.isEditMode()) s.style.display = "none";
                        ...
                        function p(e) {
                            c = e.clientX - l, e.clientY - d, c > 2 || c < t.Peel_scratch_width || (s.style.left = c + "px")
                        }
                        s.addEventListener("mousedown", function(e) {
                            e.preventDefault(), l = e.clientX - s.offsetLeft, d = e.clientY - s.offsetTop, window.addEventListener("mousemove", p, !1)
                        ...
                        T.addEventListener("touchstart", e => {
                            const t = e.touches[0];
                            E = t.clientX - T.getBoundingClientRect().left, T.style.cursor = "grabbing"
                        }), T.addEventListener("touchmove", e => {
                            if (void 0 === E) return;
                            const a = e.touches[0].clientX - E;
                            a > 4 || a < t.Peel_scratch_width || (T.style.left = a + "px")
                        }), T.addEventListener("touchend", () => {
                            E = void 0, T.style.cursor = "grab"
                        })
                    }
                }
                if ("scratch" === t.coupon_type && "" != t.dynamic_coupon)
                    if ("yes" == t.preview_modal && elementorFrontend.isEditMode()) a.querySelector("#eae-scratch-canvas").style.display = "none";
                        ...
                        var g = canvas.width,
                            ...
                            w = new Image,
                            y = new Image;
                        if (null == t.item_bg_image && null == t.item_bg_color && null == t.item_bg_color_b && (w.src = eae.plugin_url + "assets/img/coupon/scratch_img.png", w.onload = function() {
                                v.drawImage(w, 0, 0, g, h)
                            }), null != t.item_bg_image) w.src = t.item_bg_image.url, w.onload = function() {
                            v.drawImage(w, 0, 0, g, h)
                        };
                        else if (null == t.item_bg_color_b && "classic" == t.item_bg_background && null == t.item_bg_image) {
                            if (null != t.item_bg_color) {
                                let D = v.createLinearGradient(0, 0, 135, 135);
                                D.addColorStop(0, t.item_bg_color), v.fillStyle = D, v.fillRect(0, 0, g, h)
                            }
                        } else if (null != t.item_bg_color_b && null != t.item_bg_color && "gradient" == t.item_bg_background && null == t.item_bg_image) {
                            let L = v.createLinearGradient(0, 0, t.item_bg_color_stop.size, t.item_bg_color_b_stop.size);
                            L.addColorStop(0, t.item_bg_color), L.addColorStop(1, t.item_bg_color_b), v.fillStyle = L, v.fillRect(0, 0, g, h)
                        }
                        ...
                        function k(e) {
                            if (f) {
                                e.preventDefault();
                                for (var t, n, i, r, o, s = b(e, canvas), l = (i = u, r = s, Math.sqrt(Math.pow(r.x - i.x, 2) + Math.pow(r.y - i.y, 2))), d = function(e, t) {
                                        return Math.atan2(t.x - e.x, t.y - e.y)
                                    }(u, s), c = 0; c < l; c++) t = u.x + Math.sin(d) * c - 25, n = u.y + Math.cos(d) * c - 25, v.globalCompositeOperation = "destination-out", v.drawImage(y, t, n);
                                u = s, o = function(e) {
                                    (!e || e < 1) && (e = 1);
                                    for (var t = v.getImageData(0, 0, g, h).data, a = t.length, n = a / e, i = 0, r = i = 0; r < a; r += e) 0 === parseInt(t[r]) && i++;
                        ...
                        y.src = eae.plugin_url + "assets/img/coupon/brush.png", canvas.addEventListener("mousedown", _, !1), canvas.addEventListener("touchstart", _, !1), canvas.addEventListener("mousemove", k, !1), canvas.addEventListener("touchmove", k, !1), canvas.addEventListener("mouseup", C, !1), canvas.addEventListener("touchend", C, !1)
                    }
            },
        ...
        h = g.extend({
            ...
            getDefaultElements: function() {
                const e = this.$element.data("id"),
                    t = document.querySelector(".elementor-element-" + e),
                    a = t.querySelector(".eae-animated-link-wrapper");
                return {
                    eid: e,
                    element: t,
                    wrapper: a
            ...
            onInit: function() {
                ...
                a.querySelectorAll(".eae-lottie-animation").forEach(e => {
        ...
        v = g.extend({
            ...
            onInit: function() {
                const {
                    ...
                    element: a
                } = this.getDefaultElements(), n = t.querySelector(".eae-drop-content");
                if ("hover" === e.content_mode) {
                    let a;
                    t.addEventListener("mouseenter", () => {
                        clearTimeout(a), t.classList.add("eae-animation"), a = setTimeout(() => {
                            t.classList.add("eae-active")
                        }, e.show_delay.size)
                    }), t.addEventListener("mouseleave", () => {
                        e.caption_animation_out || t.classList.remove("eae-animation"), e.hide_delay.size ? a = setTimeout(() => {
                            t.classList.remove("eae-active")
                        }, e.hide_delay.size) : t.classList.remove("eae-active")
                    })
                }
                "click" === e.content_mode && t.addEventListener("click", () => {
                        t.classList.toggle("eae-active"), t.classList.contains("eae-active") ? t.classList.add("eae-animation") : e.caption_animation_out || t.classList.remove("eae-animation")
                    }),
                    function(t, a, n) {
                        const i = t.parentElement.getBoundingClientRect(),
                            ...
                            l = {
                                "bottom-left": () => ({
                                    top: e.off_set.size ? `${o.offsetHeight+e.off_set.size}` : "unset",
                                    left: 0
                                }),
                                "bottom-center": () => ({
                                    top: e.off_set.size ? `${o.offsetHeight+e.off_set.size}` : "unset",
                        ...
                        d = "string" == typeof d ? parseFloat(d) : d, c = "string" == typeof c ? parseFloat(c) : c;
                        const p = r.width,
                            f = i.left + c,
                            u = f + p;
                        f < 0 ? c = -i.left : u > s && (c -= u - s), t.style.top = `${d}px`, t.style.left = `${c}px`;
                        const m = {
                            "slide-left": () => {
                        ...
                        if (m[n]) {
                            if (m[n](), o) {
                                const a = e => {
                                    const a = {
                                        "slide-left": () => t.style.clipPath = e ? "inset(0 0 0 0)" : "inset(0 100% 0 0)",
                                        "slide-top": () => t.style.clipPath = e ? "inset(0 0 0 0)" : "inset(0 0 100% 0)",
                                        "slide-bottom": () => t.style.clipPath = e ? "inset(0 0 0 0)" : "inset(100% 0 0 0)",
                                        "slide-right": () => t.style.clipPath = e ? "inset(0 0 0 0)" : "inset(0 0 0 100%)",
                                        "animation-fade": () => t.style.opacity = e ? "1" : "0"
                                    };
                                    a[n] && a[n]()
                                };
                                let i, r = !1;
                                "hover" === e.content_mode ? (o.addEventListener("mouseenter", () => {
                                    clearTimeout(i), animationTimeout = setTimeout(() => {
                                        a(!0)
                                    }, e.show_delay.size)
            ...
            e.find(".eae-img-comp-container").imagesLoaded().done(function() {
                ab_style = e.find(".eae-img-comp-container").data("ab-style"), slider_pos = e.find(".eae-img-comp-container").data("slider-pos"), "horizontal" === ab_style ? (separator_width = parseInt(e.find(".eae-img-comp-overlay").css("border-right-width")), function(e) {
                    ...
                    function n(t) {
                        ...
                        function s(e) {
                            e.preventDefault(), o = 1, window.addEventListener("mousemove", d), n.addEventListener("touchmove", c)
                        }
                    ...
                    function a(t) {
                        ...
                        function o(e) {
                            e.preventDefault(), r = 1, window.addEventListener("mousemove", l), a.addEventListener("touchmove", c)
                        }
        ...
        }), elementorFrontend.hooks.addAction("frontend/element_ready/wts-modal-popup.default", function(e, a) {
            new Event("eaePopupLoaded");
            const n = e.find(".eae-popup-wrapper"),
                i = n.data("preview-modal"),
                r = n.data("effect"),
                o = n.data("close-button-type");
            let s = n.data("close-btn");
            s = m(s);
            const l = "icon" === o ? `<i class="eae-close ${s}"> </i>` : `<svg class="eae-close" style="-webkit-mask: url(${s}); mask: url(${s}); -webkit-mask-size: cover; mask-size: cover; -webkit-mask-repeat: no-repeat; mask-repeat: no-repeat;"></svg>`,
                d = e.find(".eae-popup-container");
            let c = d.attr("id");
            popupInstance[c] || (popupInstance[c] = d.find(".eae-popup-content").clone(!0), d.find(".eae-popup-content").empty());
            const p = e.find(".eae-popup-wrapper .eae-popup-link");
            p.on("click", function() {
                c = a(this).data("id");
                a(".eae-popup-container.eae-popup-" + c).each(function() {
                    a(this).find(".eae-popup-content").replaceWith(popupInstance[c].clone(!0))
                })
                ...
                tLoading: "Loading...",
                autoFocusLast: !0,
                mainClass: `eae-popup eae-popup-${p.data("id")} eae-wrap-${p.data("ctrl-id")}`,
                callbacks: {
                    beforeOpen: function() {
                        r && (this.st.mainClass = `eae-popup eae-popup-${p.data("id")} eae-wrap-${p.data("ctrl-id")} mfp-${r}`)
                    },
                    open: function() {
                        const e = p.data("id"),
                            n = a(`.eae-popup-${e}.eae-popup-container .eae-modal-content`);
                        t(n);
                    ...
                    afterClose: function() {
                        e.find(".eae-popup-container").find(".eae-popup-content").empty()
                    }
                }
            }), "yes" === i && e.hasClass("elementor-element-edit-mode") && p.click()
            ...
            if (!e.hasClass("elementor-element-edit-mode"))
                if ("countdown" === o) {
                    ...
                    if ("" !== u) {
                        ...
                        a - p > 0 && (document.cookie = l + "=" + u + ";" + f + ";path=/")
                    } else {
                        temp_date = a, (m = new Date).setSeconds(m.getSeconds() + e.find(".eae-evergreen-wrapper").data("egtime")), a = m.getTime(), i(s, (new Date).getTime(), n);
                        var w = new Date;
                        w.setTime(w.getTime() + 1e3 * temp_date);
                        var y = "expires=" + w.toUTCString();
                        document.cookie = l + "=" + (new Date).getTime() + ";" + y + ";path=/"
                    }
                }
            if (!e.hasClass("elementor-element-edit-mode") && a - p < 0) return d.length > 0 && d.forEach(function(a) {
            ...
            var b = setInterval(function() {
                var n = (new Date).getTime(),
                    ...
                    s = 0,
                    l = 0;
                i > 0 ? (r = Math.floor(i / 864e5), o = "0" + Math.floor(i % 864e5 / 36e5), s = "0" + Math.floor(i % 36e5 / 6e4), l = "0" + Math.floor(i % 6e4 / 1e3)) : (d.length > 0 && (e.hasClass("elementor-element-edit-mode") || d.forEach(function(a) {
                    "redirect" === a && ($url1 = e.find(".eae-evergreen-wrapper").data("redirected-url"), "" !== t.trim($url1) && (window.location.href = $url1)), "hide" === a && (e.find("#eaeclockdiv").css("display", "none"), e.find(".egt-title").css("display", "none")), "message" === a && e.find(".eae-egt-message").css("display", "block"), "hide_parent" === a && (e.hasClass("elementor-element-edit-mode") || ($p_secs = e.closest("section"), $p_secs.css("display", "none")))
                })), clearInterval(b), r = "0", o = "00", s = "00", l = "00"), r < 10 && (r = "0" + r), e.find("." + c).find("#eaedivDays").html(r), e.find("." + c).find("#eaedivHours").html(o.slice(-2)), e.find("." + c).find("#eaedivMinutes").html(s.slice(-2)), e.find("." + c).find("#eaedivSeconds").html(l.slice(-2))
            }, 1e3)
            ...
            if (!e.hasClass("elementor-element-edit-mode") && a - p < 0) return void(d.length > 0 && d.forEach(function(a) {
            ...
            var b = setInterval(function() {
                ...
                if (2 === t.trim(l).length) {
                    ...
                    p = "#eaeulSec1 li:eq( " + t.trim(l).charAt(0) + " )", f = "#eaeulSec li:eq( 0 )";
                    e.find("." + c).find(p).next().length > 0 ? (e.find("." + c).find(p).addClass("flip-clock-active"), e.find("." + c).find(p).next().addClass("flip-clock-before")) : (e.find("." + c).find("#eaeulSec1 li:last-child").addClass("flip-clock-active"), e.find("." + c).find("#eaeulSec1 li:first-child").addClass("flip-clock-before")), e.find("." + c).find(f).next().length > 0 ? (e.find("." + c).find(f).addClass("flip-clock-active"), e.find("." + c).find(f).next().addClass("flip-clock-before")) : (e.find("." + c).find("#eaeulSec li:last-child").addClass("flip-clock-active"), e.find("." + c).find("#eaeulSec li:first-child").addClass("flip-clock-before"))
                }
            ...
            var a, n = e.find(".eae-evergreen-wrapper").data("egtime"),
            ...
            if (!e.hasClass("elementor-element-edit-mode"))
                if ("countdown" === s) {
                    ...
                    var w = r(l),
                        y = "";
                    if ("" !== w) {
                        (y = new Date(parseInt(w))).setSeconds(y.getSeconds() + e.find(".eae-evergreen-wrapper").data("egtime")), n = y.getTime();
                        ...
                        n - h > 0 && (document.cookie = d + "=" + w + ";" + v + ";path=/")
                    } else {
                        temp_date = n, (y = new Date).setSeconds(y.getSeconds() + e.find(".eae-evergreen-wrapper").data("egtime")), n = y.getTime(), i(l, (new Date).getTime(), o);
                        var C = new Date;
                        C.setTime(C.getTime() + 1e3 * temp_date);
                        var x = "expires=" + C.toUTCString();
                        document.cookie = d + "=" + (new Date).getTime() + ";" + x + ";path=/"
                    }
                }
            if (!e.hasClass("elementor-element-edit-mode")) {
                var S = E(n);
            ...
            a.addListener(n), n(a)
        }), elementorFrontend.hooks.addAction("frontend/element_ready/eae-progress-bar.skin1", o), elementorFrontend.hooks.addAction("frontend/element_ready/eae-progress-bar.skin2", o), elementorFrontend.hooks.addAction("frontend/element_ready/eae-progress-bar.skin3", o), elementorFrontend.hooks.addAction("frontend/element_ready/eae-progress-bar.skin4", o), elementorFrontend.hooks.addAction("frontend/element_ready/eae-progress-bar.skin5", o), elementorFrontend.hooks.addAction("frontend/element_ready/eae-filterableGallery.default", function(e, t) {
            ...
            if (s = "x" === s ? "y" : "y" === s ? "x" : "both", "yes" === l) var c = a.attr("data-max-glare");
            l = "yes" === l;
        ...
        }), elementorFrontend.hooks.addAction("frontend/element_ready/eae-content-switcher.skin1", s), elementorFrontend.hooks.addAction("frontend/element_ready/eae-content-switcher.skin2", s), elementorFrontend.hooks.addAction("frontend/element_ready/eae-content-switcher.skin3", l), elementorFrontend.hooks.addAction("frontend/element_ready/eae-content-switcher.skin4", l), elementorFrontend.hooks.addAction("frontend/element_ready/global", function(e, t) {
            ...
            let a = swiper_outer_wrapper.data("swiper-settings"),
                n = (swiper_outer_wrapper.data("slides-per-view"), swiper_outer_wrapper.data("space"), elementorFrontend.config.responsive.activeBreakpoints);
            sliderData = {
            ...
            if (n.hasOwnProperty("mobile"))
                for (const e in i) a.hasOwnProperty(e) && (sliderData[e] = a[e].mobile), a.thumbs.hasOwnProperty(e) && (sliderData.thumbs.swiper[e] = a.thumbs[e].mobile);
            const r = {},
                o = {};
            a.hasOwnProperty("breakpoints_value") && Object.keys(a.breakpoints_value).map(e => {
            ...
            }), sliderData.breakpoints = r, sliderData.thumbs.swiper.breakpoints = o, void 0 !== a.autoplay && (sliderData.thumbs.swiper.autoplay = {
            ...
            }), "yes" == a.navigation && (sliderData.navigation = {
                nextEl: wClass + " .eae-swiper-button-next",
                prevEl: wClass + " .eae-swiper-button-prev"
            }), "" !== a.pagination && (sliderData.pagination = {
                type: a.pagination,
                el: wClass + " .swiper-pagination",
                clickable: a.clickable
            }), void 0 !== a.autoplay && (sliderData.autoplay = {
                delay: a.autoplay.duration,
                disableOnInteraction: a.autoplay.disableOnInteraction,
                reverseDirection: a.autoplay.reverseDirection
            ...
            null !== swiperContainer && 0 === swiperContainer.length || new s(jQuery(swiperContainer), sliderData).then(e => {
                const t = e,
                    n = a.pauseOnHover;
                if ("yes" == a.loop && p(t, wid), "yes" == n && f(t, n, wid, a), "yes" === a.loop) {
                    const e = t && t.thumbs ? t.thumbs.swiper : null;
                    e && "function" == typeof e.slideToLoop && t.on("slideChange", function() {
                        const a = t.realIndex;
                        a != e.realIndex && e.slideToLoop(a)
                    })
                }
                if (void 0 !== a.autoplay) {
                    "yes" == a.pauseOnHover && jQuery(wClass + " .eae-swiper-container").hover(function() {
                        null != t && (t.autoplay.stop(), t.thumbs.swiper.autoplay.stop())
                    }, function() {
                        null != t && (t.autoplay.start(), t.thumbs.swiper.autoplay.start())
                    })
                }
            })
            ...
            if (i = {
                ...
                }), "null" != n.direction && "slide" == n.effect && (i.direction = n.direction), null !== jQuery(a) && 0 === jQuery(a).length) return;
            ...
            const a = document.querySelector(".elementor-element-" + $wid),
                ...
                i = (a.querySelector(".eae-radial-chart-container").dataset.chart, e.find(".eae-radial-chart-container")),
                r = e.find(".eae-radial-chart");
            let o = i.data("chart");
            "polarArea" == o.type && "true" == o.enablePercentage && (o.options.scales.r.ticks.callback = function(e, t, a) {
                return `${e}%`
            });
            new IntersectionObserver((e, a) => {
                e.forEach(e => {
                    if (e.isIntersecting) {
                        e.target.classList.add("trigger"), null == t && (t = new Chart(r, o))
                    }
                })
            }, {
                root: null,
        ...
        }), elementorFrontend.hooks.addAction("frontend/element_ready/eae-animated-link.default", function(e) {
            elementorFrontend.elementsHandler.addHandler(h, {
                $element: e
            })
        }), elementorFrontend.hooks.addAction("frontend/element_ready/eae-dropbar.default", function(e) {
            elementorFrontend.elementsHandler.addHandler(v, {
                $element: e
            })
        })
    })
