    ...
    $.fn.jetFormConditional = function(options) {
        ...
        var setVisibility = function($section) {
            ...
            if (res) {
                ...
                $section.find('*[data-required="1"]').removeAttr('data-required').attr('required', !0)
            } else {
                $section.hide();
                ...
                $section.find('*[required="required"]').removeAttr('required').attr('data-required', 1);
    ...
    var JetEngineForms = {
        ...
        changeActiveTemplateClass: function(event) {
            ...
            if ('radio' === $this[0].type) {
                $template.closest('.jet-form__fields-group').find('.jet-form__field-template--checked').removeClass('jet-form__field-template--checked')
            }
        ...
        widgetBookingForm: function($scope) {
            ...
            if ($editor.length && window.wp && window.wp.editor) {
                $editor.each(function() {
                    JetEngineForms.wysiwygInitWithTriggers(this, !0)
                })
            }
        ...
        initFormPager: function($scope) {
            ...
            $pages.each(function() {
                ...
                if (!$page.hasClass('.jet-form-page--hidden')) {
                    JetEngineForms.initSingleFormPage($page, $form, !1)
                }
            })
        },
        ...
        switchFormPage: function($fromPage, $toPage) {
            ...
            JetEngineForms.initSingleFormPage($toPage, $form, !1);
        ...
        initRangeFields: function($scope) {
            ...
            $rangeFields.each(function() {
                JetEngineForms.updateRangeField({
                    target: $(this),
                    firstInit: !0
                })
            })
        ...
        updateRangeField: function(event) {
            var $target = $(event.target),
                ...
                val = $target.val(),
                isElemEditMode = window.elementorFrontend ? window.elementorFrontend.isEditMode() : !1;
        ...
        wysiwygInit: function(closure, replace = !1) {
            const self = $(closure),
        ...
        wysiwygInitWithTriggers: function(closure, replace = !1) {
            const {
                editorID,
                field
            } = JetEngineForms.wysiwygInit(closure, replace);
